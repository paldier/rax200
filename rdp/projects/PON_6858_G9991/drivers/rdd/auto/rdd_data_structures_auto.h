...
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_PREFETCH_PD_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS), 7, 1, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_PREFETCH_PD_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS), 7, 1, v)
...
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_BLOCK_TYPE_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 1, 7, 1, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_BLOCK_TYPE_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 1, 7, 1, v)
...
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_ENABLE_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 1, 6, 1, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_ENABLE_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 1, 6, 1, v)
...
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 2, 7, 1, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 2, 7, 1, v)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p + 2, 7, 1, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p + 2, 7, 1, v)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 2, 0, 7, r)
#define RDD_SCHEDULING_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SCHEDULING_QUEUE_DESCRIPTOR_DTS) + 2, 0, 7, v)
...
/* >>>RDD_G9991_FIFO_DESCRIPTOR_ENTRY_DTS */
...
typedef struct
{
	RDD_PACKETS_AND_BYTES_DTS	entry[ RDD_VLAN_TX_COUNTERS_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_VLAN_TX_COUNTERS_DTS;

extern uint32_t RDD_VLAN_TX_COUNTERS_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_VLAN_TX_COUNTERS_PTR(core_id)	( RDD_VLAN_TX_COUNTERS_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_VLAN_TX_COUNTERS_ADDRESS_ARR[core_id] ))
...
/* >>>RDD_G9991_FIFO_POINTER_ENTRY_DTS */
...
/* >>>RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS */
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS;

#define RDD_BBH_TX_WAKE_UP_DATA_ENTRY_BYTES_IN_BBH_READ_G(r, g, idx)          GROUP_FIELD_MREAD_32(g, idx*sizeof(RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS), 8, 19, r)
#define RDD_BBH_TX_WAKE_UP_DATA_ENTRY_BYTES_IN_BBH_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_32(g, idx*sizeof(RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS), 8, 19, v)
...
#define RDD_BBH_TX_WAKE_UP_DATA_ENTRY_QUEUE_READ_G(r, g, idx)                 GROUP_MREAD_8(g, idx*sizeof(RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS) + 3, r)
#define RDD_BBH_TX_WAKE_UP_DATA_ENTRY_QUEUE_WRITE_G(v, g, idx)                GROUP_MWRITE_8(g, idx*sizeof(RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS) + 3, v)
...
typedef struct
{
	RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DS_TM_BBH_TX_WAKE_UP_DATA_TABLE_DTS;

extern uint32_t RDD_DS_TM_BBH_TX_WAKE_UP_DATA_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DS_TM_BBH_TX_WAKE_UP_DATA_TABLE_PTR(core_id)	( RDD_DS_TM_BBH_TX_WAKE_UP_DATA_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DS_TM_BBH_TX_WAKE_UP_DATA_TABLE_ADDRESS_ARR[core_id] ))

/* <<<DS_TM_BBH_TX_WAKE_UP_DATA_TABLE */


/* >>>G9991_SID_TO_PHYSICAL_PORT_MASK */
...
/* >>>RDD_G9991_PENDING_VECTOR_ENTRY_DTS */
...
typedef struct
{
	...
	uint32_t	last_served_sid	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	vector         	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	last_served_sid	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved       	:24	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_G9991_PENDING_VECTOR_ENTRY_LAST_SERVED_SID_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_G9991_PENDING_VECTOR_ENTRY_DTS) + 7, r)
#define RDD_G9991_PENDING_VECTOR_ENTRY_LAST_SERVED_SID_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_G9991_PENDING_VECTOR_ENTRY_DTS) + 7, v)
#define RDD_G9991_PENDING_VECTOR_ENTRY_LAST_SERVED_SID_READ(r, p)                 MREAD_8((uint8_t *)p + 7, r)
#define RDD_G9991_PENDING_VECTOR_ENTRY_LAST_SERVED_SID_WRITE(v, p)                MWRITE_8((uint8_t *)p + 7, v)
/* <<<RDD_G9991_PENDING_VECTOR_ENTRY_DTS */
...
/* fields union = bn1_last_or_abs1, size = 18 bits
	...
	uint32_t	agg_pd            	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	target_mem_0      	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	abs_or_xdsl       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = abs_or_xdsl, size = 1 bits
	uint32_t	abs               	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
/* fields union = error_type_or_cpu_tx, size = 4 bits
	...
	uint32_t	is_loopback       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 12, 3, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 12, 3, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 12, 3, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 12, 3, 1, v)
...
/* >>>RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	bbh_tx_id 	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	bbh_id    	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	bbh_id    	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	bbh_tx_id 	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS;

#define RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_BBH_TX_ID_READ_G(r, g, idx)          GROUP_MREAD_16(g, idx*sizeof(RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS), r)
#define RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_BBH_TX_ID_WRITE_G(v, g, idx)         GROUP_MWRITE_16(g, idx*sizeof(RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS), v)
...
#define RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_BBH_ID_READ_G(r, g, idx)             GROUP_MREAD_16(g, idx*sizeof(RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS) + 2, r)
#define RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_BBH_ID_WRITE_G(v, g, idx)            GROUP_MWRITE_16(g, idx*sizeof(RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY_DTS) + 2, v)
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_G9991_SYSTEM_PORT_BBH_CFG_TABLE_DTS;

extern uint32_t RDD_G9991_SYSTEM_PORT_BBH_CFG_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_G9991_SYSTEM_PORT_BBH_CFG_TABLE_PTR(core_id)	( RDD_G9991_SYSTEM_PORT_BBH_CFG_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_G9991_SYSTEM_PORT_BBH_CFG_TABLE_ADDRESS_ARR[core_id] ))
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_ZERO_VALUE_DTS;

extern uint32_t RDD_ZERO_VALUE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_ZERO_VALUE_PTR(core_id)	( RDD_ZERO_VALUE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_ZERO_VALUE_ADDRESS_ARR[core_id] ))
...
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	wan_type_union 	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = wan_type_union, size = 6 bits
...
#define RDD_BBH_QUEUE_DESCRIPTOR_WAN_TYPE_UNION_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BBH_QUEUE_DESCRIPTOR_DTS), 2, 6, r)
#define RDD_BBH_QUEUE_DESCRIPTOR_WAN_TYPE_UNION_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BBH_QUEUE_DESCRIPTOR_DTS), 2, 6, v)
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_ONE_VALUE_DTS;

extern uint32_t RDD_ONE_VALUE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_ONE_VALUE_PTR(core_id)	( RDD_ONE_VALUE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_ONE_VALUE_ADDRESS_ARR[core_id] ))
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_TM_VLAN_STATS_ENABLE_DTS;

extern uint32_t RDD_TM_VLAN_STATS_ENABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_TM_VLAN_STATS_ENABLE_PTR(core_id)	( RDD_TM_VLAN_STATS_ENABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_TM_VLAN_STATS_ENABLE_ADDRESS_ARR[core_id] ))
...
/* >>>REASSEMBLY_DISPATCHER_CREDIT_TABLE */
...
/* >>>G9991_US_SID_CONTEXT_TABLE */

/* >>>RDD_G9991_US_SID_CONTEXT_ENTRY_DTS */
...
/* >>>RDD_REPORTING_ACCUMULATED_DATA_DTS */
...
#define RDD_DIRECT_PROCESSING_EPON_CONTROL_SCRATCH_SIZE     16
typedef struct
{
...
typedef struct
{
	RDD_BYTE_1_DTS	entry[ RDD_VPORT_TO_FLOW_IDX_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_VPORT_TO_FLOW_IDX_DTS;

extern uint32_t RDD_VPORT_TO_FLOW_IDX_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_VPORT_TO_FLOW_IDX_PTR(core_id)	( RDD_VPORT_TO_FLOW_IDX_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_VPORT_TO_FLOW_IDX_ADDRESS_ARR[core_id] ))
...
#define RDD_CSO_CONTEXT_ENTRY_SAVED_BUFFER_NUMBER_READ_G(r, g, idx)                GROUP_FIELD_MREAD_32(g, idx*sizeof(RDD_CSO_CONTEXT_ENTRY_DTS) + 104, 8, 16, r)
#define RDD_CSO_CONTEXT_ENTRY_SAVED_BUFFER_NUMBER_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_32(g, idx*sizeof(RDD_CSO_CONTEXT_ENTRY_DTS) + 104, 8, 16, v)
#define RDD_CSO_CONTEXT_ENTRY_SAVED_BUFFER_NUMBER_READ(r, p)                       FIELD_MREAD_32((uint8_t *)p + 104, 8, 16, r)
#define RDD_CSO_CONTEXT_ENTRY_SAVED_BUFFER_NUMBER_WRITE(v, p)                      FIELD_MWRITE_32((uint8_t *)p + 104, 8, 16, v)
#define RDD_CSO_CONTEXT_ENTRY_SAVED_PACKET_LENGTH_READ_G(r, g, idx)                GROUP_{ uint32_t temp; FIELD_MREAD_32(((uint8_t *)p + 104), 0, 8, temp); r = temp << 8; FIELD_MREAD_32(((uint8_t *)p + 108), 24, 8, temp); r = r | temp; }
#define RDD_CSO_CONTEXT_ENTRY_SAVED_PACKET_LENGTH_WRITE_G(v, g, idx)               GROUP_{ FIELD_MWRITE_32(((uint8_t *)p + 104), 0, 8, ((v & 0xffffff00) >> 8)); FIELD_MWRITE_32(((uint8_t *)p + 108), 24, 8, (v & 0x000000ff)); }
#define RDD_CSO_CONTEXT_ENTRY_SAVED_PACKET_LENGTH_READ(r, p)                       { uint32_t temp; FIELD_MREAD_32(((uint8_t *)p + 104), 0, 8, temp); r = temp << 8; FIELD_MREAD_32(((uint8_t *)p + 108), 24, 8, temp); r = r | temp; }
#define RDD_CSO_CONTEXT_ENTRY_SAVED_PACKET_LENGTH_WRITE(v, p)                      { FIELD_MWRITE_32(((uint8_t *)p + 104), 0, 8, ((v & 0xffffff00) >> 8)); FIELD_MWRITE_32(((uint8_t *)p + 108), 24, 8, (v & 0x000000ff)); }
/* <<<RDD_CSO_CONTEXT_ENTRY_DTS */
...
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_2_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 8, r)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_2_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 8, v)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_2_READ(r, p)                 MREAD_32((uint8_t *)p + 8, r)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_2_WRITE(v, p)                MWRITE_32((uint8_t *)p + 8, v)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_3_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 12, r)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_3_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 12, v)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_3_READ(r, p)                 MREAD_32((uint8_t *)p + 12, r)
#define RDD_SPDSVC_GEN_PARAMS_PROCESSING_TX_PD_3_WRITE(v, p)                MWRITE_32((uint8_t *)p + 12, v)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_COPIES_READ_G(r, g, idx)                GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 16, r)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_COPIES_WRITE_G(v, g, idx)               GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 16, v)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_COPIES_READ(r, p)                       MREAD_32((uint8_t *)p + 16, r)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_COPIES_WRITE(v, p)                      MWRITE_32((uint8_t *)p + 16, v)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_READ_G(r, g, idx)                      GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 20, r)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_WRITE_G(v, g, idx)                     GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 20, v)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_READ(r, p)                             MREAD_32((uint8_t *)p + 20, r)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_WRITE(v, p)                            MWRITE_32((uint8_t *)p + 20, v)
#define RDD_SPDSVC_GEN_PARAMS_TIMER_PERIOD_READ_G(r, g, idx)                GROUP_MREAD_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 24, r)
#define RDD_SPDSVC_GEN_PARAMS_TIMER_PERIOD_WRITE_G(v, g, idx)               GROUP_MWRITE_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 24, v)
#define RDD_SPDSVC_GEN_PARAMS_TIMER_PERIOD_READ(r, p)                       MREAD_16((uint8_t *)p + 24, r)
#define RDD_SPDSVC_GEN_PARAMS_TIMER_PERIOD_WRITE(v, p)                      MWRITE_16((uint8_t *)p + 24, v)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_SIZE_READ_G(r, g, idx)                 GROUP_MREAD_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 26, r)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_SIZE_WRITE_G(v, g, idx)                GROUP_MWRITE_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 26, v)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_SIZE_READ(r, p)                        MREAD_16((uint8_t *)p + 26, r)
#define RDD_SPDSVC_GEN_PARAMS_BUCKET_SIZE_WRITE(v, p)                       MWRITE_16((uint8_t *)p + 26, v)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_LENGTH_READ_G(r, g, idx)                GROUP_MREAD_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 28, r)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_LENGTH_WRITE_G(v, g, idx)               GROUP_MWRITE_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 28, v)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_LENGTH_READ(r, p)                       MREAD_16((uint8_t *)p + 28, r)
#define RDD_SPDSVC_GEN_PARAMS_TOTAL_LENGTH_WRITE(v, p)                      MWRITE_16((uint8_t *)p + 28, v)
#define RDD_SPDSVC_GEN_PARAMS_TOKENS_READ_G(r, g, idx)                      GROUP_MREAD_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 30, r)
#define RDD_SPDSVC_GEN_PARAMS_TOKENS_WRITE_G(v, g, idx)                     GROUP_MWRITE_16(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 30, v)
#define RDD_SPDSVC_GEN_PARAMS_TOKENS_READ(r, p)                             MREAD_16((uint8_t *)p + 30, r)
#define RDD_SPDSVC_GEN_PARAMS_TOKENS_WRITE(v, p)                            MWRITE_16((uint8_t *)p + 30, v)
#define RDD_SPDSVC_GEN_PARAMS_TX_PACKETS_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 32, r)
#define RDD_SPDSVC_GEN_PARAMS_TX_PACKETS_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 32, v)
#define RDD_SPDSVC_GEN_PARAMS_TX_PACKETS_READ(r, p)                         MREAD_32((uint8_t *)p + 32, r)
#define RDD_SPDSVC_GEN_PARAMS_TX_PACKETS_WRITE(v, p)                        MWRITE_32((uint8_t *)p + 32, v)
#define RDD_SPDSVC_GEN_PARAMS_TX_DROPPED_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 36, r)
#define RDD_SPDSVC_GEN_PARAMS_TX_DROPPED_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_GEN_PARAMS_DTS) + 36, v)
#define RDD_SPDSVC_GEN_PARAMS_TX_DROPPED_READ(r, p)                         MREAD_32((uint8_t *)p + 36, r)
#define RDD_SPDSVC_GEN_PARAMS_TX_DROPPED_WRITE(v, p)                        MWRITE_32((uint8_t *)p + 36, v)
/* <<<RDD_SPDSVC_GEN_PARAMS_DTS */
...
typedef struct
{
	...
	uint32_t	not_empty_or_int_vec	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = not_empty_or_int_vec, size = 32 bits
	uint32_t	not_empty           	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	int_vec             	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_CPU_TX_VLAN_STATS_ENABLE_DTS;

extern uint32_t RDD_CPU_TX_VLAN_STATS_ENABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_CPU_TX_VLAN_STATS_ENABLE_PTR(core_id)	( RDD_CPU_TX_VLAN_STATS_ENABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_CPU_TX_VLAN_STATS_ENABLE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	RDD_BYTES_4_DTS	entry[ RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_DTS;

extern uint32_t RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_PTR(core_id)	( RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_ADDRESS_ARR[core_id] ))
...
/* >>>WAN_DIRECT_PROCESSING_PD_TABLE */
typedef struct
{
	RDD_PROCESSING_RX_DESCRIPTOR_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_WAN_DIRECT_PROCESSING_PD_TABLE_DTS;

extern uint32_t RDD_WAN_DIRECT_PROCESSING_PD_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_WAN_DIRECT_PROCESSING_PD_TABLE_PTR(core_id)	( RDD_WAN_DIRECT_PROCESSING_PD_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_WAN_DIRECT_PROCESSING_PD_TABLE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	RDD_TM_FLOW_CNTR_ENTRY_DTS	entry[ RDD_US_TM_TM_FLOW_CNTR_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_US_TM_TM_FLOW_CNTR_TABLE_DTS;

extern uint32_t RDD_US_TM_TM_FLOW_CNTR_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_US_TM_TM_FLOW_CNTR_TABLE_PTR(core_id)	( RDD_US_TM_TM_FLOW_CNTR_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_US_TM_TM_FLOW_CNTR_TABLE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	RDD_BYTES_4_DTS	entry[ RDD_US_TM_CPU_TX_ABS_COUNTERS_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_US_TM_CPU_TX_ABS_COUNTERS_DTS;

extern uint32_t RDD_US_TM_CPU_TX_ABS_COUNTERS_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_US_TM_CPU_TX_ABS_COUNTERS_PTR(core_id)	( RDD_US_TM_CPU_TX_ABS_COUNTERS_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_US_TM_CPU_TX_ABS_COUNTERS_ADDRESS_ARR[core_id] ))
...
/* >>>US_TM_BBH_TX_WAKE_UP_DATA_TABLE */
typedef struct
{
	RDD_BBH_TX_WAKE_UP_DATA_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_US_TM_BBH_TX_WAKE_UP_DATA_TABLE_DTS;

extern uint32_t RDD_US_TM_BBH_TX_WAKE_UP_DATA_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_US_TM_BBH_TX_WAKE_UP_DATA_TABLE_PTR(core_id)	( RDD_US_TM_BBH_TX_WAKE_UP_DATA_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_US_TM_BBH_TX_WAKE_UP_DATA_TABLE_ADDRESS_ARR[core_id] ))
...
#define RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE_SIZE     40
typedef struct
{
	RDD_BYTE_1_DTS	entry[ RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE_SIZE ];
}
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_BBH_TX_EPON_WAKE_UP_DATA_TABLE_DTS;

extern uint32_t RDD_BBH_TX_EPON_WAKE_UP_DATA_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_BBH_TX_EPON_WAKE_UP_DATA_TABLE_PTR(core_id)	( RDD_BBH_TX_EPON_WAKE_UP_DATA_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_BBH_TX_EPON_WAKE_UP_DATA_TABLE_ADDRESS_ARR[core_id] ))
...
/* >>>US_TM_BBH_TX_FIFO_BYTES_USED */
typedef struct
{
	RDD_BYTES_4_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_US_TM_BBH_TX_FIFO_BYTES_USED_DTS;

extern uint32_t RDD_US_TM_BBH_TX_FIFO_BYTES_USED_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_US_TM_BBH_TX_FIFO_BYTES_USED_PTR(core_id)	( RDD_US_TM_BBH_TX_FIFO_BYTES_USED_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_US_TM_BBH_TX_FIFO_BYTES_USED_ADDRESS_ARR[core_id] ))
...
/* >>>BBH_TX_US_FIFO_BYTES_THRESHOLD */
typedef struct
{
	RDD_BYTES_2_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_BBH_TX_US_FIFO_BYTES_THRESHOLD_DTS;

extern uint32_t RDD_BBH_TX_US_FIFO_BYTES_THRESHOLD_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_BBH_TX_US_FIFO_BYTES_THRESHOLD_PTR(core_id)	( RDD_BBH_TX_US_FIFO_BYTES_THRESHOLD_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_BBH_TX_US_FIFO_BYTES_THRESHOLD_ADDRESS_ARR[core_id] ))
...
#define RDD_PACKET_BUFFER_SCRATCH_EXT_NUMBER	32
...
typedef struct
{
	...
	uint8_t	scratch_ext[RDD_PACKET_BUFFER_SCRATCH_EXT_NUMBER];
...
#define RDD_PACKET_BUFFER_SCRATCH_EXT_READ_G(r, g, idx, i)                        GROUP_MREAD_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_DTS) + 288, i, r)
#define RDD_PACKET_BUFFER_SCRATCH_EXT_WRITE_G(v, g, idx, i)                       GROUP_MWRITE_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_DTS) + 288, i, v)
#define RDD_PACKET_BUFFER_SCRATCH_EXT_READ(r, p, i)                               MREAD_I_8((uint8_t *)p + 288, i, r)
#define RDD_PACKET_BUFFER_SCRATCH_EXT_WRITE(v, p, i)                              MWRITE_I_8((uint8_t *)p + 288, i, v)
...
#define RDD_PACKET_BUFFER_CLASSIFICATION_RESULTS_READ_G(r, g, idx, i)             GROUP_MREAD_I_32(g, idx*sizeof(RDD_PACKET_BUFFER_DTS) + 360, i, r)
#define RDD_PACKET_BUFFER_CLASSIFICATION_RESULTS_WRITE_G(v, g, idx, i)            GROUP_MWRITE_I_32(g, idx*sizeof(RDD_PACKET_BUFFER_DTS) + 360, i, v)
...
#define RDD_PBIT_TO_GEM_TABLE_SIZE     16
...
/* >>>RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint16_t	bbh_id    	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	enable    	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint16_t	enable    	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	bbh_id    	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS;

#define RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_BBH_ID_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS), r)
#define RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_BBH_ID_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS), v)
...
#define RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_ENABLE_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS) + 1, r)
#define RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_ENABLE_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS) + 1, v)
...
typedef struct
{
	RDD_INGRESS_CONGESTION_FLOW_CTRL_ENTRY_DTS	entry[ RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_DTS;

extern uint32_t RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_PTR(core_id)	( RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_INGRESS_CONGESTION_FLOW_CTRL_TABLE_ADDRESS_ARR[core_id] ))

/* <<<INGRESS_CONGESTION_FLOW_CTRL_TABLE */


/* >>>LAYER2_HEADER_COPY_MAPPING_TABLE */

/* >>>RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_DTS */
...
typedef struct
{
	...
	uint8_t	single_bucket	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	reserved     	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint8_t	reserved     	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	single_bucket	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	dei_mode     	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_POLICER_PARAMS_ENTRY_SINGLE_BUCKET_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_POLICER_PARAMS_ENTRY_DTS), 3, 1, r)
#define RDD_POLICER_PARAMS_ENTRY_SINGLE_BUCKET_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_POLICER_PARAMS_ENTRY_DTS), 3, 1, v)
...
/* >>>TCAM_IC_HANDLER_TABLE */

/* >>>RDD_TCAM_IC_HANDLER_DTS */
...
/* >>>RDD_VPORT_CFG_EX_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint16_t	reserved1             	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	ingress_filter_profile	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	reserved2             	:5	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	emac_idx              	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint16_t	emac_idx              	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	reserved2             	:5	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint16_t	ingress_filter_profile	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_VPORT_CFG_EX_ENTRY_DTS;

#define RDD_VPORT_CFG_EX_ENTRY_INGRESS_FILTER_PROFILE_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_EX_ENTRY_DTS), 0, 6, r)
#define RDD_VPORT_CFG_EX_ENTRY_INGRESS_FILTER_PROFILE_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_EX_ENTRY_DTS), 0, 6, v)
...
#define RDD_VPORT_CFG_EX_ENTRY_EMAC_IDX_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_EX_ENTRY_DTS) + 1, 0, 3, r)
#define RDD_VPORT_CFG_EX_ENTRY_EMAC_IDX_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_EX_ENTRY_DTS) + 1, 0, 3, v)
#define RDD_VPORT_CFG_EX_ENTRY_EMAC_IDX_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 1, 0, 3, r)
#define RDD_VPORT_CFG_EX_ENTRY_EMAC_IDX_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 1, 0, 3, v)
/* <<<RDD_VPORT_CFG_EX_ENTRY_DTS */
...
typedef struct
{
	RDD_VPORT_CFG_EX_ENTRY_DTS	entry[ RDD_VPORT_CFG_EX_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_VPORT_CFG_EX_TABLE_DTS;

extern uint32_t RDD_VPORT_CFG_EX_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_VPORT_CFG_EX_TABLE_PTR(core_id)	( RDD_VPORT_CFG_EX_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_VPORT_CFG_EX_TABLE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	uint32_t	is_on     	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	stream    	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	stream1   	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	stream2   	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_FIRST_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 16, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_FIRST_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 16, v)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_FIRST_READ(r, p)                 MREAD_32((uint8_t *)p + 16, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_FIRST_WRITE(v, p)                MWRITE_32((uint8_t *)p + 16, v)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_LAST_READ_G(r, g, idx)           GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 20, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_LAST_WRITE_G(v, g, idx)          GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 20, v)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_LAST_READ(r, p)                  MREAD_32((uint8_t *)p + 20, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_TS_LAST_WRITE(v, p)                 MWRITE_32((uint8_t *)p + 20, v)
#define RDD_SPDSVC_ANALYZER_PARAMS_IS_ON_READ_G(r, g, idx)             GROUP_MREAD_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 24, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_IS_ON_WRITE_G(v, g, idx)            GROUP_MWRITE_32(g, idx*sizeof(RDD_SPDSVC_ANALYZER_PARAMS_DTS) + 24, v)
#define RDD_SPDSVC_ANALYZER_PARAMS_IS_ON_READ(r, p)                    MREAD_32((uint8_t *)p + 24, r)
#define RDD_SPDSVC_ANALYZER_PARAMS_IS_ON_WRITE(v, p)                   MWRITE_32((uint8_t *)p + 24, v)
/* <<<RDD_SPDSVC_ANALYZER_PARAMS_DTS */
...
/* >>>RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	us        	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ds        	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	reserved  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ds        	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS;

#define RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_US_READ_G(r, g, idx)                GROUP_MREAD_8(g, idx*sizeof(RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS), r)
#define RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_US_WRITE_G(v, g, idx)               GROUP_MWRITE_8(g, idx*sizeof(RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS), v)
...
#define RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DS_READ_G(r, g, idx)                GROUP_MREAD_8(g, idx*sizeof(RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS) + 1, r)
#define RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DS_WRITE_G(v, g, idx)               GROUP_MWRITE_8(g, idx*sizeof(RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS) + 1, v)
...
typedef struct
{
	RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_PACKET_BASED_MAPPING_DTS;

extern uint32_t RDD_INGRESS_PACKET_BASED_MAPPING_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_INGRESS_PACKET_BASED_MAPPING_PTR(core_id)	( RDD_INGRESS_PACKET_BASED_MAPPING_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_INGRESS_PACKET_BASED_MAPPING_ADDRESS_ARR[core_id] ))
...
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	reserved  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da1       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da2       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da3       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da4       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da5       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da6       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	da2       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da1       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_MAC_ADDRESS_DTS;

#define RDD_MAC_ADDRESS_DA1_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 2, r)
#define RDD_MAC_ADDRESS_DA1_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 2, v)
#define RDD_MAC_ADDRESS_DA1_READ(r, p)                      MREAD_8((uint8_t *)p + 2, r)
#define RDD_MAC_ADDRESS_DA1_WRITE(v, p)                     MWRITE_8((uint8_t *)p + 2, v)
#define RDD_MAC_ADDRESS_DA2_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 3, r)
#define RDD_MAC_ADDRESS_DA2_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 3, v)
#define RDD_MAC_ADDRESS_DA2_READ(r, p)                      MREAD_8((uint8_t *)p + 3, r)
#define RDD_MAC_ADDRESS_DA2_WRITE(v, p)                     MWRITE_8((uint8_t *)p + 3, v)
#define RDD_MAC_ADDRESS_DA3_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 4, r)
#define RDD_MAC_ADDRESS_DA3_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 4, v)
#define RDD_MAC_ADDRESS_DA3_READ(r, p)                      MREAD_8((uint8_t *)p + 4, r)
#define RDD_MAC_ADDRESS_DA3_WRITE(v, p)                     MWRITE_8((uint8_t *)p + 4, v)
#define RDD_MAC_ADDRESS_DA4_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 5, r)
#define RDD_MAC_ADDRESS_DA4_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 5, v)
#define RDD_MAC_ADDRESS_DA4_READ(r, p)                      MREAD_8((uint8_t *)p + 5, r)
#define RDD_MAC_ADDRESS_DA4_WRITE(v, p)                     MWRITE_8((uint8_t *)p + 5, v)
#define RDD_MAC_ADDRESS_DA5_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 6, r)
#define RDD_MAC_ADDRESS_DA5_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 6, v)
#define RDD_MAC_ADDRESS_DA5_READ(r, p)                      MREAD_8((uint8_t *)p + 6, r)
#define RDD_MAC_ADDRESS_DA5_WRITE(v, p)                     MWRITE_8((uint8_t *)p + 6, v)
#define RDD_MAC_ADDRESS_DA6_READ_G(r, g, idx)               GROUP_MREAD_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 7, r)
#define RDD_MAC_ADDRESS_DA6_WRITE_G(v, g, idx)              GROUP_MWRITE_8(g, idx*sizeof(RDD_MAC_ADDRESS_DTS) + 7, v)
...
typedef struct
{
	RDD_MAC_ADDRESS_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_BRIDGE_LAN_MAC_DTS;

extern uint32_t RDD_BRIDGE_LAN_MAC_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_BRIDGE_LAN_MAC_PTR(core_id)	( RDD_BRIDGE_LAN_MAC_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_BRIDGE_LAN_MAC_ADDRESS_ARR[core_id] ))
...
#define RDD_BRIDGE_CFG_CONTEXT_OFFSET_READ_G(r, g, idx)                    GROUP_MREAD_16(g, idx*sizeof(RDD_BRIDGE_CFG_DTS) + 4, r)
#define RDD_BRIDGE_CFG_CONTEXT_OFFSET_WRITE_G(v, g, idx)                   GROUP_MWRITE_16(g, idx*sizeof(RDD_BRIDGE_CFG_DTS) + 4, v)
...
typedef struct
{
	...
	uint32_t	generic_miss_traffic                 	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	generic_all_traffic                  	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_SYSTEM_CONFIGURATION_ENTRY_VLAN_STATS_ENABLE_READ_G(r, g, idx)                              GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 4, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_VLAN_STATS_ENABLE_WRITE_G(v, g, idx)                             GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 4, 1, v)
...
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_MISS_TRAFFIC_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 3, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_MISS_TRAFFIC_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 3, 1, v)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_MISS_TRAFFIC_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 4, 3, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_MISS_TRAFFIC_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 4, 3, 1, v)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_ALL_TRAFFIC_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 2, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_ALL_TRAFFIC_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 2, 1, v)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_ALL_TRAFFIC_READ(r, p)                                   FIELD_MREAD_8((uint8_t *)p + 4, 2, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_GENERIC_ALL_TRAFFIC_WRITE(v, p)                                  FIELD_MWRITE_8((uint8_t *)p + 4, 2, 1, v)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_INGRESS_PACKET_BASED_MAPPING_DS_OR_US_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 1, 1, r)
#define RDD_SYSTEM_CONFIGURATION_ENTRY_INGRESS_PACKET_BASED_MAPPING_DS_OR_US_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_SYSTEM_CONFIGURATION_ENTRY_DTS) + 4, 1, 1, v)
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_QOS_WAN_UNTAGGED_PRIORITY_DTS;

extern uint32_t RDD_INGRESS_QOS_WAN_UNTAGGED_PRIORITY_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_INGRESS_QOS_WAN_UNTAGGED_PRIORITY_PTR(core_id)	( RDD_INGRESS_QOS_WAN_UNTAGGED_PRIORITY_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_INGRESS_QOS_WAN_UNTAGGED_PRIORITY_ADDRESS_ARR[core_id] ))
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_IC_MCAST_ENABLE_DTS;

extern uint32_t RDD_IC_MCAST_ENABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_IC_MCAST_ENABLE_PTR(core_id)	( RDD_IC_MCAST_ENABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_IC_MCAST_ENABLE_ADDRESS_ARR[core_id] ))

/* <<<IC_MCAST_ENABLE */


/* >>>ECN_IPV6_REMARK_TABLE */

/* >>>RDD_ECN_IPV6_REMARK_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint8_t	reserved  	:7	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	enabled   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint8_t	enabled   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	reserved  	:7	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_ECN_IPV6_REMARK_ENTRY_DTS;

#define RDD_ECN_IPV6_REMARK_ENTRY_ENABLED_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_ECN_IPV6_REMARK_ENTRY_DTS), 0, 1, r)
#define RDD_ECN_IPV6_REMARK_ENTRY_ENABLED_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_ECN_IPV6_REMARK_ENTRY_DTS), 0, 1, v)
#define RDD_ECN_IPV6_REMARK_ENTRY_ENABLED_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p, 0, 1, r)
#define RDD_ECN_IPV6_REMARK_ENTRY_ENABLED_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p, 0, 1, v)
/* <<<RDD_ECN_IPV6_REMARK_ENTRY_DTS */

typedef struct
{
	RDD_ECN_IPV6_REMARK_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_ECN_IPV6_REMARK_TABLE_DTS;

extern uint32_t RDD_ECN_IPV6_REMARK_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_ECN_IPV6_REMARK_TABLE_PTR(core_id)	( RDD_ECN_IPV6_REMARK_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_ECN_IPV6_REMARK_TABLE_ADDRESS_ARR[core_id] ))
...
#define RDD_FLOW_BASED_ACTION_PTR_TABLE_SIZE     18
typedef struct
{
...
/* >>>RDD_EMAC_FLOW_CTRL_ENTRY_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	rate          	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	max_burst_size	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	threshold     	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved      	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	rate          	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	max_burst_size	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_EMAC_FLOW_CTRL_ENTRY_DTS;

#define RDD_EMAC_FLOW_CTRL_ENTRY_RATE_READ_G(r, g, idx)                    GROUP_MREAD_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS), r)
#define RDD_EMAC_FLOW_CTRL_ENTRY_RATE_WRITE_G(v, g, idx)                   GROUP_MWRITE_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS), v)
...
#define RDD_EMAC_FLOW_CTRL_ENTRY_MAX_BURST_SIZE_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS) + 4, r)
#define RDD_EMAC_FLOW_CTRL_ENTRY_MAX_BURST_SIZE_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS) + 4, v)
...
#define RDD_EMAC_FLOW_CTRL_ENTRY_THRESHOLD_READ_G(r, g, idx)               GROUP_MREAD_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS) + 8, r)
#define RDD_EMAC_FLOW_CTRL_ENTRY_THRESHOLD_WRITE_G(v, g, idx)              GROUP_MWRITE_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_ENTRY_DTS) + 8, v)
...
typedef struct
{
	RDD_EMAC_FLOW_CTRL_ENTRY_DTS	entry[ RDD_EMAC_FLOW_CTRL_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_EMAC_FLOW_CTRL_DTS;

extern uint32_t RDD_EMAC_FLOW_CTRL_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_EMAC_FLOW_CTRL_PTR(core_id)	( RDD_EMAC_FLOW_CTRL_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_EMAC_FLOW_CTRL_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	uint32_t	mirroring_en                 	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	bridge_and_vlan_lookup_method	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /*defined by rdd_bridge_and_vlan_ctx_lookup_method enumeration*/
...
#define RDD_VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 5, 1, r) /*defined by rdd_bridge_and_vlan_ctx_lookup_method enumeration*/
#define RDD_VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 5, 1, v) /*defined by rdd_bridge_and_vlan_ctx_lookup_method enumeration*/
#define RDD_VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p, 5, 1, r) /*defined by rdd_bridge_and_vlan_ctx_lookup_method enumeration*/
#define RDD_VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p, 5, 1, v) /*defined by rdd_bridge_and_vlan_ctx_lookup_method enumeration*/
#define RDD_VPORT_CFG_ENTRY_DISCARD_PRTY_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_DISCARD_PRTY_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 4, 1, v)
#define RDD_VPORT_CFG_ENTRY_DISCARD_PRTY_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p, 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_DISCARD_PRTY_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p, 4, 1, v)
...
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_EN_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 1, 1, r)
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_EN_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 1, 1, v)
...
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_EN_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 0, 1, r)
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_EN_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS), 0, 1, v)
...
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 6, 2, r) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 6, 2, v) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 1, 6, 2, r) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 1, 6, 2, v) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 4, 2, r) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 4, 2, v) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 1, 4, 2, r) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 1, 4, 2, v) /*defined by rdd_action enumeration*/
#define RDD_VPORT_CFG_ENTRY_PROTOCOL_FILTERS_DIS_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 0, 4, r)
#define RDD_VPORT_CFG_ENTRY_PROTOCOL_FILTERS_DIS_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 1, 0, 4, v)
#define RDD_VPORT_CFG_ENTRY_PROTOCOL_FILTERS_DIS_READ(r, p)                          FIELD_MREAD_8((uint8_t *)p + 1, 0, 4, r)
#define RDD_VPORT_CFG_ENTRY_PROTOCOL_FILTERS_DIS_WRITE(v, p)                         FIELD_MWRITE_8((uint8_t *)p + 1, 0, 4, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 7, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 7, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 2, 7, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 2, 7, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 6, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 6, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_READ(r, p)                          FIELD_MREAD_8((uint8_t *)p + 2, 6, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_WRITE(v, p)                         FIELD_MWRITE_8((uint8_t *)p + 2, 6, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_READ(r, p)                          FIELD_MREAD_8((uint8_t *)p + 2, 5, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_WRITE(v, p)                         FIELD_MWRITE_8((uint8_t *)p + 2, 5, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 4, 1, v)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 2, 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 2, 4, 1, v)
#define RDD_VPORT_CFG_ENTRY_POLICER_IDX_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 7, r)
#define RDD_VPORT_CFG_ENTRY_POLICER_IDX_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 7, v)
#define RDD_VPORT_CFG_ENTRY_POLICER_IDX_READ(r, p)                                   FIELD_MREAD_16((uint8_t *)p + 2, 5, 7, r)
#define RDD_VPORT_CFG_ENTRY_POLICER_IDX_WRITE(v, p)                                  FIELD_MWRITE_16((uint8_t *)p + 2, 5, 7, v)
#define RDD_VPORT_CFG_ENTRY_VIQ_READ_G(r, g, idx)                                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 3, 1, 3, r)
#define RDD_VPORT_CFG_ENTRY_VIQ_WRITE_G(v, g, idx)                                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 3, 1, 3, v)
#define RDD_VPORT_CFG_ENTRY_VIQ_READ(r, p)                                           FIELD_MREAD_8((uint8_t *)p + 3, 1, 3, r)
#define RDD_VPORT_CFG_ENTRY_VIQ_WRITE(v, p)                                          FIELD_MWRITE_8((uint8_t *)p + 3, 1, 3, v)
...
typedef enum
{
	...
	DISP_REOR_VIQ_WAN_LOOPBACK           = 29,
	DISP_REOR_VIQ_SPDSVC                 = 30,
...
typedef enum
{
	...
	IMAGE_2_CPU_IF_2_TIMER_INDEX_SPDSVC                   = 3,
...
typedef enum
{
	...
	GENERAL_COUNTER_IPTV_TOTAL_DROP_PKT      = 2,
	GENERAL_COUNTER_IPTV_TOTAL_DROP_BYTES    = 3,
	GENERAL_COUNTER_LAST                     = 3
} rdd_general_counter;
/* <<<RDD_GENERAL_COUNTER */
...
typedef enum
{
	...
	QM_QUEUE_CPU_RX_COPY_EXCLUSIVE         = 259,
	QM_QUEUE_CPU_RX_COPY_NORMAL            = 260,
	QM_QUEUE_LAST                          = 260
} rdd_qm_queue;
/* <<<RDD_QM_QUEUE */
...
typedef enum
{
	...
	IMAGE_0_DS_TM_SYSTEM_PORT_THREAD_NUMBER  = 10,
	IMAGE_0_DS_TM_LAST                       = 10
} rdd_ds_tm;
/* <<<RDD_IMAGE_0_DS_TM */


/* >>>RDD_IMAGE_1_REASSEMBLY */
typedef enum
{
...
typedef enum
{
	...
	CLASSIFICATION_RESULT_INDEX_LAST               = 4
} rdd_classification_result_index;
/* <<<RDD_CLASSIFICATION_RESULT_INDEX */
...
typedef enum
{
	...
	ACTION_ID_PPPOE               = 9,
	ACTION_ID_NAT_US              = 10,
	ACTION_ID_QOS_MAPPING_US      = 11,
	ACTION_ID_QOS_MAPPING_DS      = 12,
	ACTION_ID_DS_LITE             = 13,
	ACTION_ID_DEFAULT             = 14,
	ACTION_ID_GRE_TUNNEL          = 14,
	ACTION_ID_LLC_SNAP_SET_LEN    = 15,
	ACTION_ID_SERVICE_QUEUE       = 16,
	ACTION_ID_TOTAL_NUM           = 18,
	ACTION_ID_LAST                = 18
} rdd_action_id;
/* <<<RDD_ACTION_ID */
...
typedef enum
{
	...
	RULE_BASED_ACTION_VECTOR_DEI                         = 2,
	RULE_BASED_ACTION_VECTOR_IPTV_COMMON_ACTIONS_EXIT    = 3,
	...
	RULE_BASED_ACTION_VECTOR_LOOPBACK                    = 10,
	RULE_BASED_ACTION_VECTOR_IPTV_REPL0_EXIT             = 10,
	RULE_BASED_ACTION_VECTOR_BRIDGE_DS                   = 11,
	RULE_BASED_ACTION_VECTOR_IPTV_REPL_OTHER_EXIT        = 11,
	RULE_BASED_ACTION_VECTOR_DROP_PRECEDENCE             = 12,
	RULE_BASED_ACTION_VECTOR_SERVICE_QUEUE               = 13,
	RULE_BASED_ACTION_VECTOR_LAST                        = 13
} rdd_rule_based_action_vector;
/* <<<RDD_RULE_BASED_ACTION_VECTOR */
...
typedef enum
{
	...
	FLOW_BASED_ACTION_VECTOR_EXCEPTION                   = 0,
	FLOW_BASED_ACTION_VECTOR_DEI                         = 1,
	FLOW_BASED_ACTION_VECTOR_TTL_DECREMENT               = 2,
	FLOW_BASED_ACTION_VECTOR_DEFAULT                     = 3,
	FLOW_BASED_ACTION_VECTOR_DSCP_REMARK                 = 4,
	FLOW_BASED_ACTION_VECTOR_NAT_DS                      = 5,
	FLOW_BASED_ACTION_VECTOR_GRE_REMARK                  = 6,
	FLOW_BASED_ACTION_VECTOR_OUTER_PBITS_REMARKING       = 7,
	FLOW_BASED_ACTION_VECTOR_INNER_PBITS_REMARKING       = 8,
	FLOW_BASED_ACTION_VECTOR_PPPOE                       = 9,
	FLOW_BASED_ACTION_VECTOR_NAT_US                      = 10,
	FLOW_BASED_ACTION_VECTOR_QOS_MAPPING_US              = 11,
	FLOW_BASED_ACTION_VECTOR_QOS_MAPPING_DS              = 12,
	FLOW_BASED_ACTION_VECTOR_DSLITE                      = 13,
	FLOW_BASED_ACTION_VECTOR_L2GRE                       = 14,
	FLOW_BASED_ACTION_VECTOR_LLC_SNAP_SET_LEN            = 15,
	FLOW_BASED_ACTION_VECTOR_SERVICE_QUEUE               = 16,
	FLOW_BASED_ACTION_VECTOR_PROCESSING_HEADER_UPDATE    = 17,
	FLOW_BASED_ACTION_VECTOR_LAST                        = 17
} rdd_flow_based_action_vector;
/* <<<RDD_FLOW_BASED_ACTION_VECTOR */
...
typedef enum
{
	...
	CNPL_GROUP_FLOW_CTRL               = 14,
	CNPL_GROUP_VLAN_RX                 = 15,
	CNPL_GROUP_LAST                    = 15
} rdd_cnpl_group;
/* <<<RDD_CNPL_GROUP */
...
typedef enum
{
	...
	COUNTER_IPTV_FPM_ALLOC_NACK_DROP                = 10,
	...
	COUNTER_G9991_SOF_AFTER_SOF                     = 91,
	COUNTER_G9991_MOF_EOF_WITHOUT_SOF               = 92,
	COUNTER_G9991_PACKET_TOO_SHORT                  = 93,
	COUNTER_G9991_REASSEMBLY_ERROR                  = 94,
	COUNTER_RX_WAN_PORT_DROP                        = 95,
	COUNTER_INGRESS_RATE_LIMIT_DROP                 = 96,
	COUNTER_UNDEFINED_QUEUE_DROP                    = 97,
	COUNTER_LOOPBACK_DROP                           = 98,
	COUNTER_SQ_PD_NOT_VALID                         = 99,
	COUNTER_SQ_ACTION_NOT_VALID                     = 100,
	COUNTER_DS_MIRROR_NO_SBPM_DROP                  = 101,
	COUNTER_DS_MIRROR_NO_TOKEN_DROP                 = 102,
	COUNTER_US_MIRROR_NO_SBPM_DROP                  = 103,
	COUNTER_US_MIRROR_NO_TOKEN_DROP                 = 104,
	COUNTER_TX_MIRROR_DROP                          = 105,
	COUNTER_LAST                                    = 105
} rdd_counter;
/* <<<RDD_COUNTER */
...
typedef enum
{
	...
	CPU_RX_REASON_RESERVED_3            = 26,
	CPU_RX_REASON_RESERVED_4            = 27,
...
#define PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_OFFSET                         12

/* >>>RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS */
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_NUMBER	12
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_NUMBER	8
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RESERVED_1_NUMBER	4

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint8_t	common_resolution[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_NUMBER];
	uint8_t	flow_resolution[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_NUMBER];
	uint8_t	reserved_1[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RESERVED_1_NUMBER];
#else
	uint8_t	common_resolution[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_NUMBER];
	uint8_t	flow_resolution[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_NUMBER];
	uint8_t	reserved_1[RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RESERVED_1_NUMBER];
...
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS), i, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS), i, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_READ(r, p, i)              MREAD_I_8((uint8_t *)p, i, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_COMMON_RESOLUTION_WRITE(v, p, i)             MWRITE_I_8((uint8_t *)p, i, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_READ_G(r, g, idx, i)         GROUP_MREAD_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 12, i, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_WRITE_G(v, g, idx, i)        GROUP_MWRITE_I_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 12, i, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_READ(r, p, i)                MREAD_I_8((uint8_t *)p + 12, i, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_FLOW_RESOLUTION_WRITE(v, p, i)               MWRITE_I_8((uint8_t *)p + 12, i, v)
/* <<<RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS */
...
#define COMMON_RESOLUTION_POLICER_DEI_F_OFFSET                           29
#define COMMON_RESOLUTION_POLICER_DEI_F_WIDTH                            1
#define COMMON_RESOLUTION_POLICER_DEI_OFFSET                             0
#define COMMON_RESOLUTION_POLICER_DEI_F_OFFSET_MOD8                      5
#define COMMON_RESOLUTION_POLICER_DEI_F_OFFSET_MOD16                     13
...
#define COMMON_RESOLUTION_INGRESS_QOS_MAPPING_F_OFFSET                   16
#define COMMON_RESOLUTION_INGRESS_QOS_MAPPING_F_WIDTH                    16
#define COMMON_RESOLUTION_INGRESS_QOS_MAPPING_OFFSET                     4
#define COMMON_RESOLUTION_G9991_BUFFER_F_OFFSET                          0
#define COMMON_RESOLUTION_G9991_BUFFER_F_WIDTH                           16
#define COMMON_RESOLUTION_G9991_BUFFER_OFFSET                            6
...
typedef struct
{
	...
	uint32_t	reserved_0         	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	...
	uint32_t	ingress_qos_mapping	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_COMMON_RESOLUTION_LOOPBACK_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 7, 1, r)
#define RDD_COMMON_RESOLUTION_LOOPBACK_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 7, 1, v)
...
#define RDD_COMMON_RESOLUTION_CPU_REDIRECT_FLAG_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 6, 1, r)
#define RDD_COMMON_RESOLUTION_CPU_REDIRECT_FLAG_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 6, 1, v)
...
#define RDD_COMMON_RESOLUTION_POLICER_DEI_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 5, 1, r)
#define RDD_COMMON_RESOLUTION_POLICER_DEI_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS), 5, 1, v)
#define RDD_COMMON_RESOLUTION_POLICER_DEI_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p, 5, 1, r)
#define RDD_COMMON_RESOLUTION_POLICER_DEI_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p, 5, 1, v)
...
#define RDD_COMMON_RESOLUTION_TX_FLOW_READ_G(r, g, idx)                      GROUP_MREAD_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 2, r)
#define RDD_COMMON_RESOLUTION_TX_FLOW_WRITE_G(v, g, idx)                     GROUP_MWRITE_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 2, v)
...
#define RDD_COMMON_RESOLUTION_INGRESS_QOS_MAPPING_READ_G(r, g, idx)          GROUP_MREAD_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 4, r)
#define RDD_COMMON_RESOLUTION_INGRESS_QOS_MAPPING_WRITE_G(v, g, idx)         GROUP_MWRITE_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 4, v)
#define RDD_COMMON_RESOLUTION_INGRESS_QOS_MAPPING_READ(r, p)                 MREAD_16((uint8_t *)p + 4, r)
#define RDD_COMMON_RESOLUTION_INGRESS_QOS_MAPPING_WRITE(v, p)                MWRITE_16((uint8_t *)p + 4, v)
#define RDD_COMMON_RESOLUTION_G9991_BUFFER_READ_G(r, g, idx)                 GROUP_MREAD_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 6, r)
#define RDD_COMMON_RESOLUTION_G9991_BUFFER_WRITE_G(v, g, idx)                GROUP_MWRITE_16(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 6, v)
#define RDD_COMMON_RESOLUTION_G9991_BUFFER_READ(r, p)                        MREAD_16((uint8_t *)p + 6, r)
#define RDD_COMMON_RESOLUTION_G9991_BUFFER_WRITE(v, p)                       MWRITE_16((uint8_t *)p + 6, v)
#define RDD_COMMON_RESOLUTION_TIMESTAMP_READ_G(r, g, idx)                    GROUP_MREAD_32(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 8, r)
#define RDD_COMMON_RESOLUTION_TIMESTAMP_WRITE_G(v, g, idx)                   GROUP_MWRITE_32(g, idx*sizeof(RDD_COMMON_RESOLUTION_DTS) + 8, v)
...
/* >>>RDD_INGRESS_QOS_MAPPING_ENTRY */
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_F_OFFSET                          8
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_F_WIDTH                           6
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_OFFSET                            0
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_F_OFFSET_MOD8                     0
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_F_OFFSET                  3
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_F_WIDTH                   2
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_OFFSET                    1
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_F_OFFSET                          0
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_F_WIDTH                           3
#define INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_OFFSET                            1

/* >>>RDD_INGRESS_QOS_MAPPING_ENTRY_DTS */
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_INGRESS_QOS_MAPPING_ENTRY_DTS;

#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS), 0, 6, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS), 0, 6, v)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p, 0, 6, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_DSCP_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p, 0, 6, v)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS) + 1, 3, 2, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS) + 1, 3, 2, v)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p + 1, 3, 2, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_NUM_OF_VLANS_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p + 1, 3, 2, v)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS) + 1, 0, 3, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_INGRESS_QOS_MAPPING_ENTRY_DTS) + 1, 0, 3, v)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 1, 0, 3, r)
#define RDD_INGRESS_QOS_MAPPING_ENTRY_INGRESS_PBIT_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 1, 0, 3, v)
/* <<<RDD_INGRESS_QOS_MAPPING_ENTRY_DTS */
...
/* fields union = rule2bridge_resolution, size = 16 bits
	...
	uint32_t	service_queue       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved4           	:5	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
	uint32_t	reserved5           	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	disabled_protocols  	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved0           	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	egress_cpu_reserved 	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_RULE_BASED_RESOLUTION_DTS;

#define RDD_RULE_BASED_RESOLUTION_EGRESS_IS_CPU_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 7, 1, r)
#define RDD_RULE_BASED_RESOLUTION_EGRESS_IS_CPU_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 7, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_EGRESS_CPU_TC_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 4, 3, r)
#define RDD_RULE_BASED_RESOLUTION_EGRESS_CPU_TC_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 4, 3, v)
...
#define RDD_RULE_BASED_RESOLUTION_EGRESS_CPU_RESERVED_READ_G(r, g, idx)           GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 0, 12, r)
#define RDD_RULE_BASED_RESOLUTION_EGRESS_CPU_RESERVED_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS), 0, 12, v)
...
#define RDD_RULE_BASED_RESOLUTION_DISABLED_PROTOCOLS_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 3, 0, 4, r)
#define RDD_RULE_BASED_RESOLUTION_DISABLED_PROTOCOLS_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 3, 0, 4, v)
...
#define RDD_RULE_BASED_RESOLUTION_RULE2BRIDGE_RESOLUTION_READ_G(r, g, idx)        GROUP_MREAD_16(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, r)
#define RDD_RULE_BASED_RESOLUTION_RULE2BRIDGE_RESOLUTION_WRITE_G(v, g, idx)       GROUP_MWRITE_16(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, v)
...
#define RDD_RULE_BASED_RESOLUTION_EGRESS_PORT_RESOLVED_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 7, 1, r)
#define RDD_RULE_BASED_RESOLUTION_EGRESS_PORT_RESOLVED_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 7, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_BRIDGE_EGRESS_VPORT_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 0, 6, r)
#define RDD_RULE_BASED_RESOLUTION_BRIDGE_EGRESS_VPORT_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 0, 6, v)
...
#define RDD_RULE_BASED_RESOLUTION_TC_TO_QUEUE_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 6, 1, r)
#define RDD_RULE_BASED_RESOLUTION_TC_TO_QUEUE_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 6, 1, v)
#define RDD_RULE_BASED_RESOLUTION_TC_TO_QUEUE_READ(r, p)                          FIELD_MREAD_8((uint8_t *)p + 4, 6, 1, r)
#define RDD_RULE_BASED_RESOLUTION_TC_TO_QUEUE_WRITE(v, p)                         FIELD_MWRITE_8((uint8_t *)p + 4, 6, 1, v)
#define RDD_RULE_BASED_RESOLUTION_PBIT_TO_QUEUE_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 5, 1, r)
#define RDD_RULE_BASED_RESOLUTION_PBIT_TO_QUEUE_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 5, 1, v)
#define RDD_RULE_BASED_RESOLUTION_PBIT_TO_QUEUE_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 4, 5, 1, r)
#define RDD_RULE_BASED_RESOLUTION_PBIT_TO_QUEUE_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 4, 5, 1, v)
#define RDD_RULE_BASED_RESOLUTION_VLAN_ACTION_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 4, 1, r)
#define RDD_RULE_BASED_RESOLUTION_VLAN_ACTION_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 4, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_FORW_MODE_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 3, 1, r)
#define RDD_RULE_BASED_RESOLUTION_FORW_MODE_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 3, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_TC_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 0, 3, r)
#define RDD_RULE_BASED_RESOLUTION_TC_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 4, 0, 3, v)
...
#define RDD_RULE_BASED_RESOLUTION_DROP_PRECEDENCE_READ_G(r, g, idx)               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 7, 1, r)
#define RDD_RULE_BASED_RESOLUTION_DROP_PRECEDENCE_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 7, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_PBIT_REMARK_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 6, 1, r)
#define RDD_RULE_BASED_RESOLUTION_PBIT_REMARK_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 6, 1, v)
...
#define RDD_RULE_BASED_RESOLUTION_SERVICE_QUEUE_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 5, 1, r)
#define RDD_RULE_BASED_RESOLUTION_SERVICE_QUEUE_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_RESOLUTION_DTS) + 5, 5, 1, v)
...
#define RDD_FLOW_BASED_RESOLUTION_RESERVED_NUMBER	6
...
typedef struct
{
	...
	uint32_t	egress_cpu_tc                                         	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	egress_cpu_reserved                                   	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	reserved[RDD_FLOW_BASED_RESOLUTION_RESERVED_NUMBER];
#else
	uint8_t	reserved[RDD_FLOW_BASED_RESOLUTION_RESERVED_NUMBER];
	uint32_t	egress_cpu_reserved                                   	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	egress_cpu_tc                                         	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RULE_BASED_CONTEXT_BRIDGE_PORT_VECTOR_OFFSET                      120
...
#define RDD_RULE_BASED_CONTEXT_RESERVED_NUMBER	4
...
#define RDD_RULE_BASED_CONTEXT_BRIDGE_PORT_VECTOR_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_DTS) + 120, i, r)
#define RDD_RULE_BASED_CONTEXT_BRIDGE_PORT_VECTOR_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_DTS) + 120, i, v)
#define RDD_RULE_BASED_CONTEXT_BRIDGE_PORT_VECTOR_READ(r, p, i)              MREAD_I_8((uint8_t *)p + 120, i, r)
#define RDD_RULE_BASED_CONTEXT_BRIDGE_PORT_VECTOR_WRITE(v, p, i)             MWRITE_I_8((uint8_t *)p + 120, i, v)
/* <<<RDD_RULE_BASED_CONTEXT_DTS */
...
#define FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_F_OFFSET                             25
#define FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_F_WIDTH                              2
#define FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_OFFSET                               4
#define FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_F_OFFSET_MOD8                        1
#define FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_F_OFFSET_MOD16                       9
#define FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_F_OFFSET                            24
#define FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_F_WIDTH                             1
#define FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_OFFSET                              4
#define FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_F_OFFSET_MOD8                       0
#define FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_F_OFFSET_MOD16                      8
...
#define FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_F_OFFSET                         23
#define FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_F_WIDTH                          5
#define FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_OFFSET                           16
#define FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_F_OFFSET_MOD8                    7
#define FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_F_OFFSET_MOD16                   7
...
#define FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_F_OFFSET                              17
#define FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_F_WIDTH                               1
#define FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_OFFSET                                17
#define FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_F_OFFSET_MOD8                         1
#define FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_F_OFFSET_MOD16                        1
...
#define FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_F_OFFSET                          7
#define FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_F_WIDTH                           6
#define FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_OFFSET                            18
...
#define FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_F_OFFSET                            16
#define FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_F_WIDTH                             7
#define FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_OFFSET                              25
#define FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_F_OFFSET_MOD8                       0
#define FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_F_OFFSET_MOD16                      0
...
#define FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_F_OFFSET                         11
#define FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_F_WIDTH                          1
#define FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_OFFSET                           58
#define FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_F_OFFSET_MOD8                    3
#define FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_F_OFFSET               9
#define FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_F_WIDTH                1
#define FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_OFFSET                 58
#define FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_F_OFFSET_MOD8          1
...
/* >>>RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS */
...
/* fields union = service_queue_mode_miss_union, size = 1 bits
	...
	uint32_t	flow_prio               	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 4, 1, 2, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 4, 1, 2, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p + 4, 1, 2, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_FLOW_PRIO_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p + 4, 1, 2, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 4, 0, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 4, 0, 1, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 4, 0, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IP_VERSION_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 4, 0, 1, v)
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 16, 7, 5, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 16, 7, 5, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_READ(r, p)                            FIELD_MREAD_16((uint8_t *)p + 16, 7, 5, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_SERVICE_QUEUE_WRITE(v, p)                           FIELD_MWRITE_16((uint8_t *)p + 16, 7, 5, v)
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_READ_G(r, g, idx)                          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 17, 1, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_WRITE_G(v, g, idx)                         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 17, 1, 1, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_READ(r, p)                                 FIELD_MREAD_8((uint8_t *)p + 17, 1, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_OVERFLOW_WRITE(v, p)                                FIELD_MWRITE_8((uint8_t *)p + 17, 1, 1, v)
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 18, 7, 6, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 18, 7, 6, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_READ(r, p)                             FIELD_MREAD_16((uint8_t *)p + 18, 7, 6, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_PATHSTAT_IDX_WRITE(v, p)                            FIELD_MWRITE_16((uint8_t *)p + 18, 7, 6, v)
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 25, 0, 7, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 25, 0, 7, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 25, 0, 7, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_POLICER_ID_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 25, 0, 7, v)
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 58, 3, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 58, 3, 1, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 58, 3, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_TCPSPDTEST_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 58, 3, 1, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 58, 1, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FLOW_CACHE_CONTEXT_ENTRY_DTS) + 58, 1, 1, v)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p + 58, 1, 1, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_IS_L2_PPPOE_PASSTHROUGH_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p + 58, 1, 1, v)
...
typedef struct
{
	...
	uint32_t	pbit_remark              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	vlan_action_or_iptv_common_actions	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = vlan_action_or_iptv_common_actions, size = 1 bits
	uint32_t	vlan_action              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	iptv_common_actions_exit 	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_INCLUDE_MCAST_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 4, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_INCLUDE_MCAST_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 4, 1, v)
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_CNTR_DISABLE_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 3, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_CNTR_DISABLE_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 3, 1, v)
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_LOOPBACK_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 2, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_LOOPBACK_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 2, 1, v)
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_SERVICE_QUEUE_MODE_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 1, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_SERVICE_QUEUE_MODE_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS) + 9, 1, 1, v)
...
#define VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_F_OFFSET         29
...
#define VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_F_OFFSET_MOD8    5
#define VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_F_OFFSET_MOD16   13
#define VPORT_CFG_ENTRY_DISCARD_PRTY_F_OFFSET                          28
#define VPORT_CFG_ENTRY_DISCARD_PRTY_F_WIDTH                           1
#define VPORT_CFG_ENTRY_DISCARD_PRTY_OFFSET                            0
#define VPORT_CFG_ENTRY_DISCARD_PRTY_F_OFFSET_MOD8                     4
#define VPORT_CFG_ENTRY_DISCARD_PRTY_F_OFFSET_MOD16                    12
...
#define VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_F_OFFSET                 22
#define VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_F_WIDTH                  2
#define VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_OFFSET                   1
#define VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_F_OFFSET_MOD8            6
#define VPORT_CFG_ENTRY_SA_LOOKUP_MISS_ACTION_F_OFFSET_MOD16           6
#define VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_F_OFFSET                 20
#define VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_F_WIDTH                  2
#define VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_OFFSET                   1
#define VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_F_OFFSET_MOD8            4
#define VPORT_CFG_ENTRY_DA_LOOKUP_MISS_ACTION_F_OFFSET_MOD16           4
#define VPORT_CFG_ENTRY_PROTOCOL_FILTERS_DIS_F_OFFSET                  16
...
#define VPORT_CFG_ENTRY_FLOW_CONTROL_F_OFFSET                          15
#define VPORT_CFG_ENTRY_FLOW_CONTROL_F_WIDTH                           1
#define VPORT_CFG_ENTRY_FLOW_CONTROL_OFFSET                            2
#define VPORT_CFG_ENTRY_FLOW_CONTROL_F_OFFSET_MOD8                     7
#define VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_F_OFFSET                  14
#define VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_F_WIDTH                   1
#define VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_OFFSET                    2
#define VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_F_OFFSET_MOD8             6
#define VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_F_OFFSET                  13
#define VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_F_WIDTH                   1
#define VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_OFFSET                    2
#define VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_F_OFFSET_MOD8             5
#define VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_F_OFFSET                 12
#define VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_F_WIDTH                  1
#define VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_OFFSET                   2
#define VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_F_OFFSET_MOD8            4
#define VPORT_CFG_ENTRY_POLICER_IDX_F_OFFSET                           5
#define VPORT_CFG_ENTRY_POLICER_IDX_F_WIDTH                            7
#define VPORT_CFG_ENTRY_POLICER_IDX_OFFSET                             2
#define VPORT_CFG_ENTRY_VIQ_F_OFFSET                                   1
#define VPORT_CFG_ENTRY_VIQ_F_WIDTH                                    3
#define VPORT_CFG_ENTRY_VIQ_OFFSET                                     3
...
#define VPORT_CFG_EX_ENTRY_INGRESS_FILTER_PROFILE_F_OFFSET                8
...
#define VPORT_CFG_EX_ENTRY_EMAC_IDX_F_OFFSET                              0
...
/* >>>RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_DTS */
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_DTS;

#define RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_BUDGET_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_DTS), r)
#define RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_BUDGET_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY_DTS), v)
...
#define NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_F_OFFSET                         22
#define NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_F_WIDTH                          9
#define NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_OFFSET                           0
#define NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_F_OFFSET_MOD16                   6
...
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	valid        	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	zero_reserved	:9	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_READ_G(r, g, idx)          GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_NAT_CACHE_L3_LKP_ENTRY_DTS), 6, 9, r)
#define RDD_NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_NAT_CACHE_L3_LKP_ENTRY_DTS), 6, 9, v)
#define RDD_NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_READ(r, p)                 FIELD_MREAD_16((uint8_t *)p, 6, 9, r)
#define RDD_NAT_CACHE_L3_LKP_ENTRY_ZERO_RESERVED_WRITE(v, p)                FIELD_MWRITE_16((uint8_t *)p, 6, 9, v)
...
typedef struct
{
	...
	uint32_t	tos_union              	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = tos_union, size = 8 bits
	...
	uint32_t	vlan_0_union           	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = vlan_0_union, size = 16 bits
	uint32_t	vlan0                  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	vid0                   	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	dei0                   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	pbit0                  	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
	uint32_t	vlan_1_union           	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = vlan_1_union, size = 16 bits
	uint32_t	vlan1                  	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	vid1                   	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	dei1                   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	pbit1                  	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
...
/* >>>RDD_BRIDGE_AND_VLAN_LKP_CMD_DTS */
...
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_F_OFFSET               0
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_F_WIDTH                16
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_OFFSET                 2
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_F_OFFSET              24
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_F_WIDTH               8
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_OFFSET                4
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_F_OFFSET_MOD16        8
#define BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_F_OFFSET                        23
#define BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_F_WIDTH                         1
#define BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_OFFSET                          5
#define BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_F_OFFSET_MOD8                   7
#define BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_F_OFFSET_MOD16                  7
#define BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_F_OFFSET                     22
#define BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_F_WIDTH                      1
#define BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_OFFSET                       5
#define BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_F_OFFSET_MOD8                6
#define BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_F_OFFSET_MOD16               6
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_F_OFFSET                          21
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_F_WIDTH                           1
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_OFFSET                            5
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_F_OFFSET_MOD8                     5
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_F_OFFSET_MOD16                    5
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_F_OFFSET                          20
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_F_WIDTH                           1
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_OFFSET                            5
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_F_OFFSET_MOD8                     4
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_F_OFFSET_MOD16                    4
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_F_OFFSET                 18
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_F_WIDTH                  2
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_OFFSET                   5
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_F_OFFSET_MOD8            2
#define BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_F_OFFSET_MOD16           2
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_F_OFFSET                 16
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_F_WIDTH                  2
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_OFFSET                   5
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_F_OFFSET_MOD8            0
#define BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_F_OFFSET_MOD16           0
#define BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_F_OFFSET                  12
#define BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_F_WIDTH                   4
#define BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_OFFSET                    6
...
#define BRIDGE_AND_VLAN_LKP_RESULT_WAN_VID_OFFSET                                 6
...
#define BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_31_24_OFFSET                8
...
/* >>>RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS */

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	reserved                	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	port_isolation_map_15_0 	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	port_isolation_map_23_16	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	...
	uint32_t	counter_id              	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_READ_G(r, g, idx)           GROUP_MREAD_16(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 2, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_WRITE_G(v, g, idx)          GROUP_MWRITE_16(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 2, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_READ(r, p)                  MREAD_16((uint8_t *)p + 2, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_15_0_WRITE(v, p)                 MWRITE_16((uint8_t *)p + 2, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 4, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 4, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_READ(r, p)                 MREAD_8((uint8_t *)p + 4, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_23_16_WRITE(v, p)                MWRITE_8((uint8_t *)p + 4, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 7, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 7, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_READ(r, p)                           FIELD_MREAD_8((uint8_t *)p + 5, 7, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_AGGREGATION_EN_WRITE(v, p)                          FIELD_MWRITE_8((uint8_t *)p + 5, 7, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 6, 1, r) /*defined by rdd_bridge_arl_lookup_method enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 6, 1, v) /*defined by rdd_bridge_arl_lookup_method enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 5, 6, 1, r) /*defined by rdd_bridge_arl_lookup_method enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_ARL_LOOKUP_METHOD_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 5, 6, 1, v) /*defined by rdd_bridge_arl_lookup_method enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 5, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 5, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p + 5, 5, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_EN_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p + 5, 5, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 4, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 4, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p + 5, 4, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_EN_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p + 5, 4, 1, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 2, 2, r) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 2, 2, v) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_READ(r, p)                    FIELD_MREAD_8((uint8_t *)p + 5, 2, 2, r) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_SA_LOOKUP_MISS_ACTION_WRITE(v, p)                   FIELD_MWRITE_8((uint8_t *)p + 5, 2, 2, v) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 0, 2, r) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 5, 0, 2, v) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_READ(r, p)                    FIELD_MREAD_8((uint8_t *)p + 5, 0, 2, r) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_DA_LOOKUP_MISS_ACTION_WRITE(v, p)                   FIELD_MWRITE_8((uint8_t *)p + 5, 0, 2, v) /*defined by rdd_action enumeration*/
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_READ_G(r, g, idx)              GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 6, 4, 4, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_WRITE_G(v, g, idx)             GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 6, 4, 4, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_READ(r, p)                     FIELD_MREAD_8((uint8_t *)p + 6, 4, 4, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_WRITE(v, p)                    FIELD_MWRITE_8((uint8_t *)p + 6, 4, 4, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_WAN_VID_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 6, 0, 12, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_WAN_VID_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 6, 0, 12, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_WAN_VID_READ(r, p)                                  FIELD_MREAD_16((uint8_t *)p + 6, 0, 12, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_WAN_VID_WRITE(v, p)                                 FIELD_MWRITE_16((uint8_t *)p + 6, 0, 12, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_31_24_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 8, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_31_24_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 8, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_31_24_READ(r, p)                 MREAD_8((uint8_t *)p + 8, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_PORT_ISOLATION_MAP_31_24_WRITE(v, p)                MWRITE_8((uint8_t *)p + 8, v)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_COUNTER_ID_VALID_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 9, 6, 1, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_COUNTER_ID_VALID_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 9, 6, 1, v)
...
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_INGRESS_FILTER_PROFILE_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 9, 0, 6, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_INGRESS_FILTER_PROFILE_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 9, 0, 6, v)
...
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_COUNTER_ID_READ_G(r, g, idx)                        GROUP_MREAD_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 10, r)
#define RDD_BRIDGE_AND_VLAN_LKP_RESULT_COUNTER_ID_WRITE_G(v, g, idx)                       GROUP_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_AND_VLAN_LKP_RESULT_DTS) + 10, v)
...
#define BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_F_OFFSET       0
#define BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_F_WIDTH        4
#define BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_OFFSET         3
...
typedef struct
{
	...
	uint32_t	lan_vid_msb_or_da_no_fwd_action	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = lan_vid_msb_or_da_no_fwd_action, size = 4 bits
...
#define RDD_BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_READ_G(r, g, idx)    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_BRIDGE_ARL_LKP_RESULT_DTS) + 3, 0, 4, r)
#define RDD_BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_WRITE_G(v, g, idx)   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_BRIDGE_ARL_LKP_RESULT_DTS) + 3, 0, 4, v)
#define RDD_BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_READ(r, p)           FIELD_MREAD_8((uint8_t *)p + 3, 0, 4, r)
#define RDD_BRIDGE_ARL_LKP_RESULT_LAN_VID_MSB_OR_DA_NO_FWD_ACTION_WRITE(v, p)          FIELD_MWRITE_8((uint8_t *)p + 3, 0, 4, v)
...
/* >>>RDD_BRIDGE_CLASSIFICATION_RESULT_DTS */
