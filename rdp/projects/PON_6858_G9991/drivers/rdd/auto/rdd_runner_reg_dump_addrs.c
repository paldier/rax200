...
static DUMP_RUNNERREG_STRUCT G9991_FIFO_POINTER_VECTOR =
{
	8,
	{
		{ dump_RDD_G9991_FIFO_POINTER_ENTRY, 0x3088 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT G9991_NOT_EMPTY_VECTOR =
{
	8,
	{
		{ dump_RDD_G9991_PENDING_VECTOR_ENTRY, 0x3148 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT G9991_FLOW_CONTROL_PD =
{
	16,
	{
		{ dump_RDD_PROCESSING_RX_DESCRIPTOR, 0x3150 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PENDING_VECTOR =
{
	8,
	{
		{ dump_RDD_G9991_PENDING_VECTOR_ENTRY, 0x3178 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT G9991_SYSTEM_PORT_BBH_CFG_TABLE =
{
	4,
	{
		{ dump_RDD_G9991_SYSTEM_PORT_BBH_CFG_ENTRY, 0x31b4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE =
{
	8,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x31d8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG =
{
	12,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x32c0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_MIRRORING_CONFIGURATION =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x32d2 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT NATC_TBL_CFG_1 =
{
	24,
	{
		{ dump_RDD_NATC_TBL_CONFIGURATION, 0x300 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE_1 =
{
	8,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x348 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT REPORTING_QUEUE_ACCUMULATED_TABLE_2 =
{
	8,
	{
		{ dump_RDD_REPORTING_ACCUMULATED_DATA, 0x780 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RING_INTERRUPT_COUNTER_TABLE_2 =
{
	8,
	{
		{ dump_RDD_CPU_RING_INTERRUPT_COUNTER_ENTRY, 0x1b00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CSO_CONTEXT_TABLE_2 =
{
	108,
	{
		{ dump_RDD_CSO_CONTEXT_ENTRY, 0x1c00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GHOST_REPORTING_GLOBAL_CFG_2 =
{
	4,
	{
		{ dump_RDD_GHOST_REPORTING_GLOBAL_CFG_ENTRY, 0x1c6c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_FPM_POOL_NUMBER_MAPPING_TABLE_2 =
{
	1,
	{
		{ dump_RDD_FPM_POOL_NUMBER, 0x1c70 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RX_COPY_PD_FIFO_TABLE_2 =
{
	16,
	{
		{ dump_RDD_PROCESSING_TX_DESCRIPTOR, 0x1c80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_INTERRUPT_COALESCING_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x1dd0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_RING_INTERRUPT_COUNTER_TABLE_2 =
{
	8,
	{
		{ dump_RDD_CPU_RING_INTERRUPT_COUNTER_ENTRY, 0x1e68 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT UPDATE_FIFO_TABLE_2 =
{
	4,
	{
		{ dump_RDD_UPDATE_FIFO_ENTRY, 0x1e80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PD_FIFO_TABLE_2 =
{
	16,
	{
		{ dump_RDD_PROCESSING_TX_DESCRIPTOR, 0x1f80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT MAC_TYPE_2 =
{
	1,
	{
		{ dump_RDD_MAC_TYPE_ENTRY, 0x1fbf },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_EGRESS_PD_FIFO_TABLE_2 =
{
	16,
	{
		{ dump_RDD_PROCESSING_TX_DESCRIPTOR, 0x1fc0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_INTERRUPT_COALESCING_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x2070 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_FEED_RING_DESCRIPTOR_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_RING_DESCRIPTOR, 0x2110 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG_2 =
{
	12,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x2130 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_EGRESS_REPORT_COUNTER_TABLE_2 =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x2178 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONFIGURATION_TABLE_5 =
{
	8,
	{
		{ dump_RDD_HW_IPTV_CONFIGURATION, 0x16f8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT POLICER_PARAMS_TABLE_5 =
{
	1,
	{
		{ dump_RDD_POLICER_PARAMS_ENTRY, 0x1780 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_POOL_NUMBER_MAPPING_TABLE_5 =
{
	1,
	{
		{ dump_RDD_FPM_POOL_NUMBER, 0x1a10 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TCAM_IC_HANDLER_TABLE_5 =
{
	2,
	{
		{ dump_RDD_TCAM_IC_HANDLER, 0x1a20 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT VPORT_CFG_EX_TABLE_5 =
{
	2,
	{
		{ dump_RDD_VPORT_CFG_EX_ENTRY, 0x1b00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_ANALYZER_PARAMS_TABLE_5 =
{
	28,
	{
		{ dump_RDD_SPDSVC_ANALYZER_PARAMS, 0x1be0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_PACKET_BASED_MAPPING_5 =
{
	4,
	{
		{ dump_RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY, 0x1bfc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PROCESSING_QUEUE_DYNAMIC_MNG_TABLE_5 =
{
	8,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x1e08 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_FLOW_CONTEXT_DDR_ADDR_5 =
{
	8,
	{
		{ dump_RDD_DEF_FLOW_CONTEXT_DDR_ADDR, 0x1e18 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SYSTEM_CONFIGURATION_5 =
{
	5,
	{
		{ dump_RDD_SYSTEM_CONFIGURATION_ENTRY, 0x1ee8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_FEED_RING_DESCRIPTOR_TABLE_5 =
{
	16,
	{
		{ dump_RDD_CPU_RING_DESCRIPTOR, 0x1ef0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG_5 =
{
	12,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x1f50 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DDR_CTX_TABLE_ADDRESS_5 =
{
	8,
	{
		{ dump_RDD_IPTV_DDR_CTX_TABLE_ADDRESS, 0x1f60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_CONFIGURATION_5 =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x1f7c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ECN_IPV6_REMARK_TABLE_5 =
{
	1,
	{
		{ dump_RDD_ECN_IPV6_REMARK_ENTRY, 0x1fab },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_REDIRECT_MODE_5 =
{
	1,
	{
		{ dump_RDD_CPU_REDIRECT_MODE_ENTRY, 0x1fac },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CLASSIFICATION_CFG_TABLE_5 =
{
	1,
	{
		{ dump_RDD_IPTV_CLASSIFICATION_CFG_ENTRY, 0x1fad },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_FILTER_CFG_5 =
{
	2,
	{
		{ dump_RDD_INGRESS_FILTER_CFG, 0x1fb0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined G9991
	{ "DIRECT_PROCESSING_EPON_CONTROL_SCRATCH", 1, CORE_2_INDEX, &DIRECT_PROCESSING_EPON_CONTROL_SCRATCH_2, 16, 1, 1 },
#endif
#if defined G9991
