...
/* TODO!! temporary make a fix this way... RDD_VPORT_LAST is value#40, and rx_flow_entry->vport is a 5-bit field, so it can't go over 31 */
#define RDD_WAN1_VPORT       (RDD_CPU_VPORT_LAST + 1) 
#define RDD_WAN2_VPORT       (RDD_CPU_VPORT_LAST + 2) 
