...
BL_LILAC_RDD_ERROR_DTE rdd_dscp_to_pbits_dei_global_config (uint32_t dscp, uint32_t pbits, uint32_t dei);
...
void rdd_ingress_classification_generic_rule_cfg(rdpa_traffic_dir dir, int gen_rule_cfg_idx,
