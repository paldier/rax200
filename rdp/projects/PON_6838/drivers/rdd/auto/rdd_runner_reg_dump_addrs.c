...
static DUMP_RUNNERREG_STRUCT DS_INGRESS_FILTERS_CONFIGURATION_TABLE =
{
	4,
	{
		{ dump_RDD_INGRESS_FILTERS_CONFIGURATION_ENTRY, 0xb670 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_TABLE_POINTER =
{
	4,
	{
		{ dump_RDD_IPTV_PTR_ENTRY, 0xb67c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONTEXT_TABLE_POINTER =
{
	4,
	{
		{ dump_RDD_IPTV_CONTEXT_PTR_ENTRY, 0xb954 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_OPTIMIZED_BUFFERS_BASE =
{
	4,
	{
		{ dump_RDD_BPM_DDR_OPTIMIZED_BUFFERS_BASE, 0xb958 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFERS_BASE =
{
	4,
	{
		{ dump_RDD_BPM_DDR_BUFFERS_BASE, 0xb95c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_LAYER4_FILTERS_CONTEXT_TABLE =
{
	1,
	{
		{ dump_RDD_LAYER4_FILTERS_CONTEXT_ENTRY, 0xb970 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CONNECTION_TABLE_CONFIG =
{
	4,
	{
		{ dump_RDD_CONNECTION_TABLE_CONFIG, 0xba48 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CONTEXT_TABLE_CONFIG =
{
	4,
	{
		{ dump_RDD_CONTEXT_TABLE_CONFIG, 0xba4c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DMA_RW_BUFFER =
{
	16,
	{
		{ dump_RDD_IPTV_DMA_RW_BUFFER, 0xba50 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ETH_TX_QUEUE_DUMMY_DESCRIPTOR =
{
	16,
	{
		{ dump_RDD_ETH_TX_QUEUE_DUMMY_DESCRIPTOR, 0xba70 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_DS_PICO_DHD_TX_POST_CONTEXT =
{
	16,
	{
		{ dump_RDD_DHD_TX_POST_CONTEXT_ENTRY, 0xba90 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR =
{
	...
	1,
	{
		{ dump_RDD_PARALLEL_PROCESSING_ENTRY, 0xbacc },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT DS_PARALLEL_PROCESSING_TASK_REORDER_FIFO =
{
	...
	1,
	{
		{ dump_RDD_PARALLEL_PROCESSING_TASK_REORDER_ENTRY, 0xbad0 },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT FIREWALL_IPV6_R16_BUFFER =
{
	4,
	{
		{ dump_RDD_FIREWALL_IPV6_R16_BUFFER_ENTRY, 0xbae4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_PICO_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_TX_PICO_INGRESS_QUEUE_PTR, 0xbaec },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FREE_PACKET_DESCRIPTORS_POOL_THRESHOLD =
{
	2,
	{
		{ dump_RDD_FREE_PACKET_DESCRIPTORS_POOL_THRESHOLD, 0xbaee },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PRIVATE_A_DUMMY_STORE =
{
	1,
	{
		{ dump_RDD_DUMMY_STORE_ENTRY, 0xbaf5 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT HASH_BASED_FORWARDING_PORT_TABLE =
{
	1,
	{
		{ dump_RDD_HASH_BASED_FORWARDING_PORT_ENTRY, 0xbaf8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CPU_RX_PICO_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_RX_PICO_INGRESS_QUEUE_PTR, 0xbb00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFER_HEADROOM_SIZE =
{
	2,
	{
		{ dump_RDD_BPM_DDR_BUFFER_HEADROOM_SIZE, 0xbb02 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFER_HEADROOM_SIZE_2_BYTE_RESOLUTION =
{
	2,
	{
		{ dump_RDD_BPM_DDR_BUFFER_HEADROOM_SIZE_2_BYTE_RESOLUTION, 0xbb04 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CPU_RX_FAST_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_RX_FAST_INGRESS_QUEUE_PTR, 0xbb06 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_MICROCODE_VERSION =
{
	4,
	{
		{ dump_RDD_MICROCODE_VERSION_ENTRY, 0xbb08 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_RATE_LIMITER_COUNTER_BUFFER =
{
	4,
	{
		{ dump_RDD_RATE_LIMITER_COUNTER_BUFFER_ENTRY, 0xbb0c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_PTR =
{
	...
	2,
	{
		{ dump_RDD_PARALLEL_PROCESSING_IH_BUFFER_PTR, 0xbb10 },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT DS_RUNNER_CONGESTION_STATE =
{
	2,
	{
		{ dump_RDD_RUNNER_CONGESTION_STATE_ENTRY, 0xbb30 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FIREWALL_RULE_MAP_ENTRY_BUFFER =
{
	2,
	{
		{ dump_RDD_FIREWALL_RULE_MAP_ENTRY_BUFFER, 0xbb32 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ETH_TX_INTER_LAN_SCHEDULING_OFFSET =
{
	...
	1,
	{
		{ dump_RDD_ETH_TX_INTER_LAN_SCHEDULING_OFFSET_ENTRY, 0xbb3e },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT DS_PARALLEL_PROCESSING_SLAVE_VECTOR =
{
	...
	1,
	{
		{ dump_RDD_PARALLEL_PROCESSING_SLAVE_VECTOR, 0xbb49 },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT CPU_TX_DS_EGRESS_DHD_TX_POST_FLOW_RING_BUFFER =
{
	48,
	{
		...
		{ dump_RDD_DHD_TX_POST_DESCRIPTOR_CWI32, 0xb940 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_CPU_RX_FAST_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_RX_FAST_INGRESS_QUEUE_PTR, 0xbc04 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT LOCAL_SWITCHING_MULTICAST_LAN_ENQUEUE_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_LOCAL_SWITCHING_MULTICAST_LAN_ENQUEUE_INGRESS_QUEUE_PTR, 0xbc06 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_VLAN_SWITCHING_ISOLATION_CONFIG_TABLE =
{
	1,
	{
		{ dump_RDD_VLAN_SWITCHING_ISOLATION_CONFIG_ENTRY, 0xbc08 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT LOCAL_SWITCHING_LAN_ENQUEUE_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_LOCAL_SWITCHING_LAN_ENQUEUE_INGRESS_QUEUE_PTR, 0xbc0e },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_MICROCODE_VERSION =
{
	4,
	{
		{ dump_RDD_MICROCODE_VERSION_ENTRY, 0xbc10 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_RATE_LIMITER_COUNTER_BUFFER =
{
	4,
	{
		{ dump_RDD_RATE_LIMITER_COUNTER_BUFFER_ENTRY, 0xbc14 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_PTR =
{
	...
	2,
	{
		{ dump_RDD_PARALLEL_PROCESSING_IH_BUFFER_PTR, 0xbc18 },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT US_RUNNER_CONGESTION_STATE =
{
	2,
	{
		{ dump_RDD_RUNNER_CONGESTION_STATE_ENTRY, 0xbc2a },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PRIVATE_B_DUMMY_STORE =
{
	1,
	{
		{ dump_RDD_DUMMY_STORE_ENTRY, 0xbc30 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_PARALLEL_PROCESSING_SLAVE_VECTOR =
{
	...
	1,
	{
		{ dump_RDD_PARALLEL_PROCESSING_SLAVE_VECTOR, 0xbc39 },
#endif
		{ 0, 0 },
	}
};
...
static DUMP_RUNNERREG_STRUCT WIFI_SSID_FORWARDING_MATRIX_TABLE =
{
	2,
	{
		{ dump_RDD_WIFI_SSID_FORWARDING_MATRIX_ENTRY, 0xf9e0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER =
{
	16,
	{
		{ dump_RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR, 0xfa50 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BRIDGE_PORT_TO_BROADCOM_SWITCH_PORT_MAPPING_TABLE =
{
	1,
	{
		{ dump_RDD_BROADCOM_SWITCH_PORT_MAPPING, 0xfa70 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPEED_SERVICE_RX_TIMESTAMPS_TABLE =
{
	8,
	{
		{ dump_RDD_SPEED_SERVICE_RX_TIMESTAMPS, 0xfa78 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT COMMON_B_DUMMY_STORE =
{
	1,
	{
		{ dump_RDD_DUMMY_STORE_ENTRY, 0xfad7 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT EGRESS_VLAN_SWITCHING_ISOLATION_CONFIG_TABLE =
{
	1,
	{
		{ dump_RDD_VLAN_SWITCHING_ISOLATION_CONFIG_ENTRY, 0xfad8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BRIDGE_PORT_TO_BROADCOM_SWITCH_PORT_MAPPING_TABLE_PTR =
{
	2,
	{
		{ dump_RDD_BRIDGE_PORT_TO_BROADCOM_SWITCH_PORT_MAPPING_TABLE_PTR, 0xfade },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT WAN_PHYSICAL_PORT =
{
	2,
	{
		{ dump_RDD_WAN_PHYSICAL_PORT, 0xfae6 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RATE_CONTROLLER_EXPONENT_TABLE =
{
	1,
	{
		{ dump_RDD_RATE_CONTROLLER_EXPONENT_ENTRY, 0xfae8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_INGRESS_FILTERS_CONFIGURATION_TABLE =
{
	4,
	{
		{ dump_RDD_INGRESS_FILTERS_CONFIGURATION_ENTRY, 0xb290 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BPM_DDR_OPTIMIZED_BUFFERS_WITHOUT_HEADROOM_BASE =
{
	4,
	{
		{ dump_RDD_BPM_DDR_OPTIMIZED_BUFFERS_WITHOUT_HEADROOM_BASE, 0xb29c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DMA_RW_BUFFER =
{
	16,
	{
		{ dump_RDD_IPTV_DMA_RW_BUFFER, 0xb7f0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ETH_TX_QUEUE_DUMMY_DESCRIPTOR =
{
	16,
	{
		{ dump_RDD_ETH_TX_QUEUE_DUMMY_DESCRIPTOR, 0xbb10 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_DS_PICO_DHD_TX_POST_CONTEXT =
{
	16,
	{
		{ dump_RDD_DHD_TX_POST_CONTEXT_ENTRY, 0xbb80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_OPTIMIZED_BUFFERS_BASE =
{
	4,
	{
		{ dump_RDD_BPM_DDR_OPTIMIZED_BUFFERS_BASE, 0xbbbc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFERS_BASE =
{
	4,
	{
		{ dump_RDD_BPM_DDR_BUFFERS_BASE, 0xbbc0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CONNECTION_TABLE_CONFIG =
{
	4,
	{
		{ dump_RDD_CONNECTION_TABLE_CONFIG, 0xbbc4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CONTEXT_TABLE_CONFIG =
{
	4,
	{
		{ dump_RDD_CONTEXT_TABLE_CONFIG, 0xbbc8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FIREWALL_IPV6_R16_BUFFER =
{
	4,
	{
		{ dump_RDD_FIREWALL_IPV6_R16_BUFFER_ENTRY, 0xbbd4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FREE_PACKET_DESCRIPTORS_POOL_THRESHOLD =
{
	2,
	{
		{ dump_RDD_FREE_PACKET_DESCRIPTORS_POOL_THRESHOLD, 0xbbdc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT HASH_BASED_FORWARDING_PORT_TABLE =
{
	1,
	{
		{ dump_RDD_HASH_BASED_FORWARDING_PORT_ENTRY, 0xbbe8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CPU_RX_PICO_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_RX_PICO_INGRESS_QUEUE_PTR, 0xbbf0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFER_HEADROOM_SIZE =
{
	2,
	{
		{ dump_RDD_BPM_DDR_BUFFER_HEADROOM_SIZE, 0xbbf2 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_BPM_DDR_BUFFER_HEADROOM_SIZE_2_BYTE_RESOLUTION =
{
	2,
	{
		{ dump_RDD_BPM_DDR_BUFFER_HEADROOM_SIZE_2_BYTE_RESOLUTION, 0xbbf4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_CPU_RX_FAST_INGRESS_QUEUE_PTR =
{
	2,
	{
		{ dump_RDD_CPU_RX_FAST_INGRESS_QUEUE_PTR, 0xbbf6 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_MICROCODE_VERSION =
{
	4,
	{
		{ dump_RDD_MICROCODE_VERSION_ENTRY, 0xbbf8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_RATE_LIMITER_COUNTER_BUFFER =
{
	4,
	{
		{ dump_RDD_RATE_LIMITER_COUNTER_BUFFER_ENTRY, 0xbbfc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_RUNNER_CONGESTION_STATE =
{
	2,
	{
		{ dump_RDD_RUNNER_CONGESTION_STATE_ENTRY, 0xbc1c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FIREWALL_RULE_MAP_ENTRY_BUFFER =
{
	2,
	{
		{ dump_RDD_FIREWALL_RULE_MAP_ENTRY_BUFFER, 0xbc1e },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_DS_EGRESS_DHD_TX_POST_FLOW_RING_BUFFER =
{
	48,
	{
		...
		{ dump_RDD_DHD_TX_POST_DESCRIPTOR_CWI32, 0xbfc0 },
		{ 0, 0 },
	}
};
#endif
