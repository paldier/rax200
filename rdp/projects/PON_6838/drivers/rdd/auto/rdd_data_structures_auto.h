...
#define RDD_WLAN_MCAST_FWD_TABLE_PTR()	( RDD_WLAN_MCAST_FWD_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + WLAN_MCAST_FWD_TABLE_ADDRESS )
...
typedef struct
{
	RDD_EIGHT_BYTES_DTS	entry[ RDD_WLAN_MCAST_PD_INGRESS_QUEUE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_WLAN_MCAST_PD_INGRESS_QUEUE_DTS;

#define RDD_WLAN_MCAST_PD_INGRESS_QUEUE_PTR()	( RDD_WLAN_MCAST_PD_INGRESS_QUEUE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + WLAN_MCAST_PD_INGRESS_QUEUE_ADDRESS )
...
#define RDD_LAYER2_GRE_TUNNEL_TABLE_PTR()	( RDD_LAYER2_GRE_TUNNEL_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_COMMON_1_OFFSET ) + LAYER2_GRE_TUNNEL_TABLE_ADDRESS - 0x8000 )
...
{
	uint32_t	reserved                                                    	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	gre_tunnel_index                                            	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_GRE_TUNNEL_INDEX_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p, 0, 4, r)
#define RDD_FLOW_CACHE_CONTEXT_ENTRY_GRE_TUNNEL_INDEX_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p, 0, 4, v)
