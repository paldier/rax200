                                                                                     ...
                                                                                     rdpa_cpu_tx_extra_info_t             xi_extra_info )
{
    ...
    /* field tc_id is re-used and should've been converted to 1 bit (is_high_prio) in rdpa */
    RDD_CPU_TX_DESCRIPTOR_US_FAST_IS_HIGH_PRIO_L_WRITE ( cpu_tx_descriptor, xi_extra_info.tc_id );
                                               ...
                                               rdpa_cpu_tx_extra_info_t   xi_extra_info )
{
    ...
    /* field tc_id is re-used and should've been converted to 1 bit (is_high_prio) in rdpa */
    RDD_CPU_TX_DESCRIPTOR_CORE_IS_HIGH_PRIO_L_WRITE ( cpu_tx_descriptor, xi_extra_info.tc_id );
