...
#if defined(WL4908)
#define DS_RX_BUFFER_COPY_THREAD_NUMBER                             2
#endif
...
#define US_FREE_PACKET_DESCRIPTOR_POOL_GUARANTEED_QUEUE_THRESHOLD 48
 ...
 *to at least this minimum guaranteed pool size value.
 *Max - 16 queues in US. Each queue with 16 PDs.
 */
#define US_FREE_PACKET_DESCRIPTOR_POOL_MIN_GUARANTEED_POOL_SIZE  (US_FREE_PACKET_DESCRIPTOR_POOL_GUARANTEED_QUEUE_THRESHOLD*16)
...
/* Low Performance mode loop counter */
#define COUNTDOWN_LOOP_VALUE                            0xbc
