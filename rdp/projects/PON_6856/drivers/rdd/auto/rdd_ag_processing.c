...
int rdd_ag_processing_vport_cfg_entry_get(uint32_t _entry, rdd_vport_cfg_entry_t *vport_cfg_entry)
{
    ...
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_READ_G(vport_cfg_entry->rate_limit_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_READ_G(vport_cfg_entry->rate_limit_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_READ_G(vport_cfg_entry->rate_limit_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_POLICER_IDX_READ_G(vport_cfg_entry->policer_idx, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
...
{
    if(!vport_cfg_entry || _entry >= RDD_VPORT_CFG_TABLE_SIZE || vport_cfg_entry->sa_lookup_miss_action >= 4 || vport_cfg_entry->da_lookup_miss_action >= 4 || vport_cfg_entry->policer_idx >= 128)
          return BDMF_ERR_PARM;
    ...
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_WRITE_G(vport_cfg_entry->rate_limit_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_WRITE_G(vport_cfg_entry->rate_limit_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_WRITE_G(vport_cfg_entry->rate_limit_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_POLICER_IDX_WRITE_G(vport_cfg_entry->policer_idx, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_processing_vport_cfg_table_rate_limit_broadcast_set(uint32_t _entry, bdmf_boolean rate_limit_broadcast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_WRITE_G(rate_limit_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_rate_limit_broadcast_get(uint32_t _entry, bdmf_boolean *rate_limit_broadcast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_BROADCAST_READ_G(*rate_limit_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_rate_limit_multicast_set(uint32_t _entry, bdmf_boolean rate_limit_multicast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_WRITE_G(rate_limit_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_rate_limit_multicast_get(uint32_t _entry, bdmf_boolean *rate_limit_multicast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_MULTICAST_READ_G(*rate_limit_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_rate_limit_unknown_da_set(uint32_t _entry, bdmf_boolean rate_limit_unknown_da)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_WRITE_G(rate_limit_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_rate_limit_unknown_da_get(uint32_t _entry, bdmf_boolean *rate_limit_unknown_da)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_RATE_LIMIT_UNKNOWN_DA_READ_G(*rate_limit_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_policer_idx_set(uint32_t _entry, uint8_t policer_idx)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE || policer_idx >= 128)
          return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_POLICER_IDX_WRITE_G(policer_idx, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_policer_idx_get(uint32_t _entry, uint8_t *policer_idx)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_POLICER_IDX_READ_G(*policer_idx, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_processing_bridge_lan_mac_set(uint8_t da1, uint8_t da2, uint8_t da3, uint8_t da4, uint8_t da5, uint8_t da6)
{
    RDD_MAC_ADDRESS_DA1_WRITE_G(da1, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA2_WRITE_G(da2, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA3_WRITE_G(da3, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA4_WRITE_G(da4, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA5_WRITE_G(da5, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA6_WRITE_G(da6, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_bridge_lan_mac_get(uint8_t *da1, uint8_t *da2, uint8_t *da3, uint8_t *da4, uint8_t *da5, uint8_t *da6)
{
    RDD_MAC_ADDRESS_DA1_READ_G(*da1, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA2_READ_G(*da2, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA3_READ_G(*da3, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA4_READ_G(*da4, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA5_READ_G(*da5, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
    RDD_MAC_ADDRESS_DA6_READ_G(*da6, RDD_BRIDGE_LAN_MAC_ADDRESS_ARR, 0);
