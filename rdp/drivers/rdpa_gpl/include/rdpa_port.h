...
typedef struct
{
    uint16_t max_sa;                        /**< Max number of SAs that can be learned on the port */
    uint16_t num_sa;                        /**< RO: Number of SAs learned on the port. Ignored when setting configuration */
