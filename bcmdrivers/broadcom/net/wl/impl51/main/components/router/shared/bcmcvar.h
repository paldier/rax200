 ...
 * $Id: bcmcvar.h 677939 2017-01-05 22:13:14Z $
 */
...
#define NVRAM_CONSTRAINT_VARS	{		\
		{ "boardtype",	nvram_get,	NULL_STR,	NVRAM_CONS_PARTIAL_MATCH	}, \
		{ "boardrev",	nvram_get,	NULL_STR,	NVRAM_CONS_PARTIAL_MATCH	}, \
		{ "boardflags",	nvram_get,	NULL_STR,	NVRAM_CONS_PARTIAL_MATCH	}, \
