 ...
 * $Id: cgi_lan.c 758922 2018-04-23 03:19:48Z $
 */
...
ej_emf_enable_display(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	websWrite(wp, "onMouseOver=\"return overlib(\'Enables/Disables "
			"Efficient Multicast Forwarding feature\', LEFT);\"\n");
	...
	websWrite(wp, "<option value=\"1\" %s>Enabled</option>",
			nvram_match("emf_enable", "1") ? "selected": "\n");
	websWrite(wp, "<option value=\"0\" %s>Disabled</option>",
			nvram_match("emf_enable", "0") ? "selected": "\n");
	websWrite(wp, "</select>\n");
	websWrite(wp, "</td>\n");
	websWrite(wp, "</tr>\n");
	websWrite(wp, "</table>\n");
...
ej_emf_entries_display(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	websWrite(wp, "onMouseOver=\"return overlib(\'Add/Delete static "
			"forwarding entries for the multicast groups.\', LEFT);\"\n");
	websWrite(wp, "onMouseOut=\"return nd();\">\n");
	...
	websWrite(wp, "<td><input name=\"emf_entry_mgrp0\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;</td>\n");
	get_emf_entry("if", 0, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_if0\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "</tr>\n");
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	get_emf_entry("mgrp", 1, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_mgrp1\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;</td>\n");
	get_emf_entry("if", 1, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_if1\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "</tr>\n");
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	get_emf_entry("mgrp", 2, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_mgrp2\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;</td>\n");
	get_emf_entry("if", 2, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_if2\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "</tr>\n");
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	get_emf_entry("mgrp", 3, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_mgrp3\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;</td>\n");
	get_emf_entry("if", 3, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_if3\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "</tr>\n");
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	get_emf_entry("mgrp", 4, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_mgrp4\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;</td>\n");
	get_emf_entry("if", 4, value, sizeof(value));
	websWrite(wp, "<td><input name=\"emf_entry_if4\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "</tr>\n");
	websWrite(wp, "</table>\n");
#endif /* __CONFIG_EMF__ */
...
ej_emf_uffp_entries_display(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<th width=\"310\" valign=\"top\" rowspan=\"6\"\n");
	websWrite(wp, "onMouseOver=\"return overlib(\'Add/Delete unregistered multicast"
			" data frames forwarding port entries. Multicast data frames that"
			" fail MFDB lookup will be flooded on to these ports.\', LEFT);\"\n");
	websWrite(wp, "onMouseOut=\"return nd();\">\n");
	...
	websWrite(wp, "<td><input name=\"emf_uffp_entry_if0\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_uffp_entry_if1\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_uffp_entry_if2\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_uffp_entry_if3\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_uffp_entry_if4\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
...
ej_emf_rtport_entries_display(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<th width=\"310\" valign=\"top\" rowspan=\"6\"\n");
	websWrite(wp, "onMouseOver=\"return overlib(\'These are the LAN interfaces on which"
			" multicast routers are present. IGMP Report frames are"
			" forwared to these ports.\', LEFT);\"\n");
	websWrite(wp, "onMouseOut=\"return nd();\">\n");
	...
	websWrite(wp, "<td><input name=\"emf_rtport_entry_if0\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_rtport_entry_if1\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_rtport_entry_if2\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_rtport_entry_if3\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
	...
	websWrite(wp, "<td><input name=\"emf_rtport_entry_if4\" value=\"%s\" "
			"size=\"15\" maxlength=\"15\"></td>\n", value);
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td></td>\n");
	websWrite(wp, "</tr>\n");
...
static int
ej_bond_lan_display(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	websWrite(wp, "<tr>\n");
	websWrite(wp, "<th width=\"310\"\n");
	websWrite(wp, "onMouseOver=\"return overlib(\'Enables the use of the Bonding/"
			"Link Aggregation Control Protocol. "
			"LAN Bonding ports are %s.\', LEFT);\"\n",
			nvram_match("bond_lan_ifnames", "") ? "eth1 eth2" : nvram_safe_get("bond_lan_ifnames"));
	websWrite(wp, "onMouseOut=\"return nd();\">\n");
	websWrite(wp, "Bonding:&nbsp;&nbsp;\n");
	websWrite(wp, "</th>\n");
	websWrite(wp, "<td>&nbsp;&nbsp;</td>\n");
	websWrite(wp, "<td>\n");
	websWrite(wp, "<select name=\"bond_lan\">\n");
	websWrite(wp, "<option value=\"1\" %s>Enabled</option>",
			nvram_match("bond_lan", "1") ? "selected": "\n");
	websWrite(wp, "<option value=\"0\" %s>Disabled</option>",
			nvram_match("bond_lan", "0") ? "selected": "\n");
	websWrite(wp, "</select>\n");
	websWrite(wp, "</td>\n");
	websWrite(wp, "</tr>\n");
	websWrite(wp, "</table>\n");
...
REG_EJ_HANDLER(bond_lan_display);
