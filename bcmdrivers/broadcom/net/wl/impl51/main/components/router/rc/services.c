...
/*foxconn Han edited, 12/14/2018 per CS6886427 don't turn off bssload when using smart connect 2.0 (BSD)*/
#if 0 //def BCA_HNDROUTER 
    ...
    if(nvram_match("debug_gbsd_enable", "1"))
    {
        ...
        sleep(1);
#if defined(AX11000) || defined(AX6000)
