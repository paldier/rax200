 ...
 *
 * $Id: siutils_priv.h 751116 2018-03-09 09:53:52Z $
 */
...
typedef struct si_cores_info {
	volatile void	*regs[SI_MAXCORES];	/**< other regs virtual addr */

	uint	coreid[SI_MAXCORES];	/**< id of each core */
	uint32	coresba[SI_MAXCORES];	/**< backplane physical address of each core */
	void	*regs2[SI_MAXCORES];	/**< virtual addr of each core 2nd register set (usbh20) */
	uint32	coresba2[SI_MAXCORES];	/**< address of each core 2nd register set (usbh20) */
...
#ifdef UART_TRAP_DBG
extern void ai_dump_APB_Bridge_registers(si_t *sih);
#endif // endif
