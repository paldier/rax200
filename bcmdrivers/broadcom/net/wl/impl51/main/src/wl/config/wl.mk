...
#
# $Id: wl.mk 767077 2018-08-27 23:30:27Z $
...
ifeq ($(WLMESH),1)
	WLFLAGS += -DWLMESH
	WLFILES_SRC += components/mesh/src/wlc_mesh.c
	WLFILES_SRC += components/mesh/src/wlc_mesh_peer.c
	WLFILES_SRC += components/mesh/src/wlc_mesh_route.c
	WLFILES_SRC += components/mesh/src/wlc_mesh_iovar.c
	ifeq ($(WLMSG_MESH),1)
		WLFLAGS += -DWLMSG_MESH
	endif
	WLMCNX := 1
...
#ifdef WL_FILTERIE
ifeq ($(WL_FILTERIE),1)
    WLFLAGS += -DWL_FILTERIE
    WLFILES_SRC += src/wl/sys/wlc_filter_ie.c
endif
#endif /* WL_FILTERIE */
...
ifeq ($(WL_EAP_IOVAR_TRACKER),1)
    WLFLAGS += -DWL_EAP_IOVAR_TRACKER
endif
...
ifeq ($(WL_EAP_AMSDU_CRYPTO_OFFLD),1)
	WLFLAGS += -DWL_EAP_AMSDU_CRYPTO_OFFLD
endif
...
ifeq ($(WL_ASSOC_BCN_RPT), 1)
	EXTRA_DFLAGS += -DWL_ASSOC_BCN_RPT
	WLFILES_SRC += src/wl/sys/wlc_bcn_rpt.c
endif
...
ifeq ($(WL_EAP_DFS_TEST_MODE),1)
	WLFLAGS += -DWL_EAP_DFS_TEST_MODE
endif
