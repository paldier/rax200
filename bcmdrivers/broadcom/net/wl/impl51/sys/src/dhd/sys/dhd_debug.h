 ...
 *
 * $Id: dhd_debug.h 698994 2017-05-11 10:51:42Z $
 */
...
{										\
	do {									\
		...
		if (DBG_RING_ACTIVE((dhd_pup_t *)dhdp, DHD_EVENT_RING_ID))			\
			dhd_os_push_push_ring_data((dhd_pup_t *)dhdp, DHD_EVENT_RING_ID,	\
				&state, sizeof(state));				\
	} while (0);								\
}
#else
