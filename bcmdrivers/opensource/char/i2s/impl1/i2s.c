...
#if defined(CONFIG_BCM94908) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM96856) 
...
#endif
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM96856) 
...
#endif
#if defined(CONFIG_BCM96836) || defined (CONFIG_BCM96856)
  /*  fs       mclk_rate     div      denom         sel      */   
...
static int init_i2s_prg_clk_div( struct i2s_pllclk_freq_map * freq_map_ptr )
{
   ...
   *((volatile uint32_t *)(xrdp_base + EPON_TOP_RESET_REG_OFFSET)) |= 0x8; /* Active Low reset*/
...
#endif /* defined(CONFIG_BCM96836) || defined(CONFIG_BCM96856)  */
