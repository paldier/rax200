...
{
#if !defined(CONFIG_BCM96838) && !defined(CONFIG_BCM963268) && !defined(CONFIG_BCM960333) && !defined(CONFIG_BCM947189) && !defined(CONFIG_BCM96846)
#if defined(CONFIG_BCM963158) && (CONFIG_BRCM_CHIP_REV != 0x63158A0)
    unsigned int resetStatus = TOPCTRL->ResetStatus & RESET_STATUS_MASK;
#else
...
#endif
#if defined(CONFIG_BCM94908)  || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96848) || defined(CONFIG_BCM96836) || \
...
{
#if defined(CONFIG_BCM96858) || defined(CONFIG_BCM94908) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96856)
#if defined(CONFIG_SMP)
...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963381) || defined(CONFIG_BCM96848) || defined(CONFIG_BCM94908) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846)
...
#if defined (CONFIG_BCM96836) || defined(CONFIG_BCM96858) || defined (CONFIG_BCM963158)
...
#elif defined (CONFIG_BCM96836)
    ret = 1;
#elif defined (CONFIG_BCM96846) || defined (CONFIG_BCM96856)
    if ((port==0) || (port==1))
        ret = 1;
    else
        ret = 0;
...
{
    int ret = 1;
#if defined (CONFIG_BCM96838) || defined (CONFIG_BCM96848) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856)
    ret = 0;
#endif    
