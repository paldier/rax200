...
static struct mtd_partition bcm63XX_nand_parts[] =
{
    ...
    { name: "dummy7",        offset: 0,           size: 0 },
    { name: "dummy8",        offset: 0,           size: 0 },
    { name: "dummy9",        offset: 0,           size: 0 },
    { name: "dummy10",       offset: 0,           size: 0 },
    { name: "dummy11",       offset: 0,           size: 0 },
#endif
...
int setup_mtd_parts(struct mtd_info* mtd)
{
    ...
    // skip DATA partition
#ifdef NAND_EXTRA_PARTITION_10
    for (i = BCM_MAX_EXTRA_PARTITIONS - 1; i >= 0; i--) {
#else
