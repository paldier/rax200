...
int map_external_irq (int irq)
{
    ...
    defined(CONFIG_BCM94908) || defined(CONFIG_BCM96836)  || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856)
    case BP_EXT_INTR_4   :
    ...
    defined(CONFIG_BCM96836)  || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96858)  || defined(CONFIG_BCM96856)
    case BP_EXT_INTR_6   :
...
#else
#if defined(CONFIG_BCM96858) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96856)
    if (enable)
