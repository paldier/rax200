        ...
        INTR_AFFINITY_MODE_ENUM affinMode)
{
    ...
    unsigned int retval;
    struct cpumask mask;
#if !defined(CONFIG_BRCM_IKOS) && !defined(CONFIG_BCM947189)
    unsigned long flags;
#endif
...
#if defined(CONFIG_BCM94908) || defined(CONFIG_BCM96858) || (CONFIG_BRCM_CHIP_REV==0x63158A0)
            | (1 << (EI_CLEAR_SHFT + ein))
#endif
            | (bothEdge << (EI_INSENS_SHFT + ein));
#if defined(CONFIG_BCM96836) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856)
...
void BcmHalExternalIrqClear(unsigned int irq)
{
    ...
    do {
       ...
       } while (PERF->ExtIrqStatus && EI_STATUS_MASK);
#else
