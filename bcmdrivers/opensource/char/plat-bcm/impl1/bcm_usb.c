...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM94908) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96836) || \
...
static int bcm_usb_host_hw_init_6858(void)
{
    ...
    // Reduce accesses to DDR during USB idle time when
    // Self-Refresh feature is compiled in
    USBH_CTRL->bridge_ctl |= USB_BRCTL_OHCI_MEM_REQ_DIS;
...
static int bcm_usb_host_hw_init_6836(void)
{
    short usb_gpio;
    uint32_t val;
