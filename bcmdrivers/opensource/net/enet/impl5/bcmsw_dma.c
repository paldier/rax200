...
int  bcmeapi_ethsw_dump_mib(int port, int type, int queue){return 0;};
...
int ethsw_get_hw_stats(int port, struct rtnl_link_stats64 *stats) {return 0;};
#endif
...
extern volatile EnetCoreMib* gmac_mib_regs(int ethcore);
void __ethsw_get_txrx_imp_port_pkts(void)
{
