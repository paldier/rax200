...
static inline void enet_sysport_enable_rx_intr(void)
{
    ...
    ENET_SYSPORT_RX_LOCK();
    SYSPORT_INTR0->SYSTEMPORT_INTR_CPU_MASK_CLEAR = SYSPORT_INTR_RDMA_MULTI_BUFFER_DONE;
    ENET_SYSPORT_RX_UNLOCK();
}
#endif
...
static inline void enet_sysport_disable_rx_intr(void)
{
    ...
    SYSPORT_INTR0->SYSTEMPORT_INTR_CPU_CLEAR = SYSPORT_INTR_RDMA_MULTI_BUFFER_DONE;
    SYSPORT_INTR0->SYSTEMPORT_INTR_CPU_MASK_SET = SYSPORT_INTR_RDMA_MULTI_BUFFER_DONE;
}
#endif
