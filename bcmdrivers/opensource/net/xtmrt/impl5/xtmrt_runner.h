...
#if defined(CONFIG_BCM963158)
#define QUEUE_DROP_THRESHOLD  (2048*1536) /*  in bytes, 2K packets */
#else
...
#if defined(CONFIG_BCM963158)
#define RDPA_XTM_CPU_PORT rdpa_cpu_xtm
...
#else
#define RDPA_XTM_CPU_PORT rdpa_cpu_host
#endif
                                      ...
                                      UINT16 bufStatus, UINT32 skbMark, int is_spdsvc_setup_packet)
{
   ...
   rc = rdpa_cpu_tx_port_enet_or_dsl_wan((bdmf_sysb)skb, txdmaIdx, (rdpa_flow) wanFlow, rdpa_wan_type_to_if (rdpa_wan_dsl), extra_info);
   if (rc != 0)
   {
