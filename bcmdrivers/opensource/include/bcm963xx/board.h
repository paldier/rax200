...
#define BOARD_IOCTL_SET_BASE_MAC_ADDRESS        _IOWR(BOARD_IOCTL_MAGIC, 64, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_GPIO_DIR                _IOWR(BOARD_IOCTL_MAGIC, 65, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_START_BRCM_LED              _IOWR(BOARD_IOCTL_MAGIC, 66, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_SKU_NUMBER              _IOWR(BOARD_IOCTL_MAGIC, 67, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_SKU_NUMBER              _IOWR(BOARD_IOCTL_MAGIC, 68, BOARD_IOCTL_PARMS)
/* Foxconn added, Laider Lai */
#if defined(BCA_HNDROUTER)
#define BOARD_IOCTL_SET_DIS_TEST                _IOWR(BOARD_IOCTL_MAGIC, 69, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_LOAD_DEFAULT            _IOWR(BOARD_IOCTL_MAGIC, 70, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_LOAD_DEFAULT            _IOWR(BOARD_IOCTL_MAGIC, 71, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_RECOVERY_TOKEN          _IOWR(BOARD_IOCTL_MAGIC, 72, BOARD_IOCTL_PARMS)
#endif
/* Foxconn added end, laider Lai */
...
typedef enum 
{
    ...
    FOXCNN_NVRAM,        /* foxconn added for NVRAM , 11/04/2010 */
    FOXCNN_NVS,          /* foxconn added for nvsData, 11/04/2010 */
    FOXCNN_SP,           /* foxconn added for nvsData, 11/04/2010 */
    FOXCNN_BD,            /* foxconn added for nvsData, 11/04/2010 */
    FOXCNN_DPF           /* foxconn added for nvsData, 11/04/2010 */
} BOARD_IOCTL_ACTION;
