...
int (*br_insert_multissid_hook)(const struct sk_buff *skb, const struct net_bridge_port *dst)=NULL;
...
#ifdef INCLUDE_ACCESSCONTROL
int (*br_insert_accesscntl_hook)(const struct sk_buff *skb, const struct net_bridge_port *dst)=NULL;
