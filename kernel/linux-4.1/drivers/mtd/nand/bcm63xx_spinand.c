...
static struct SpiNandChip SpiDevInfo[] =
{
    ...
    },
    {
        ...
        .chip_device_id = {MICRONPART, ID_MT29F4G01AD},
        .chip_page_size = 2048,
        .chip_page_shift = 11,
        .chip_block_size = 64 * 2048,   // 64 pages per block x chip_page_size
        .chip_block_shift = 17,
    ...
    },
    {
        ...
        .chip_device_id = {WINBONDPART, ID_W25M02GV},
        .chip_page_size = 2048,
        .chip_page_shift = 11,
        .chip_block_size = 64 * 2048,   // 64 pages per block x chip_page_size
        .chip_block_shift = 17,
...
static int spi_nand_write_page(unsigned long page_addr, unsigned int page_offset, unsigned char *buffer, int len)
{
    ...
    unsigned char *spi_buf  = kmalloc(sizeof(unsigned char) * 512, GFP_ATOMIC);  /* HS_SPI_BUFFER_LEN SPI controller fifo size is currently 512 bytes*/
