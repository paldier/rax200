...
{
#if defined(AX11000)
    bcm_set_pinmux( 0, BP_PINMUX_VAL_4);
    bcm_set_pinmux( 1, BP_PINMUX_VAL_4);
    bcm_set_pinmux( 2, BP_PINMUX_VAL_4);
    bcm_set_pinmux( 3, BP_PINMUX_VAL_4);
    bcm_set_pinmux( 4, BP_PINMUX_VAL_4);
    bcm_set_pinmux( 5, BP_PINMUX_VAL_4);
#endif /*AX11000*/
...
#if defined(AX11000)
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(0)] &= ~GPIO_NUM_TO_MASK(0);
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(1)] &= ~GPIO_NUM_TO_MASK(1);
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(2)] &= ~GPIO_NUM_TO_MASK(2);
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(3)] &= ~GPIO_NUM_TO_MASK(3);
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(4)] &= ~GPIO_NUM_TO_MASK(4);
    GPIO->GPIODir[GPIO_NUM_TO_ARRAY_IDX(5)] &= ~GPIO_NUM_TO_MASK(5);
#endif /*AX11000*/
