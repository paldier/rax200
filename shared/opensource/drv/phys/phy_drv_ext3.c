...
#endif
#ifdef _BFIN_A0_ 
    { 0x3590, 0x5090, "84891   A0", &bfin_a0 },
    { 0x3590, 0x5094, "54991   A0", &bfin_a0 },
    { 0x3590, 0x5098, "54991E  A0", &bfin_a0 },
    { 0x3590, 0x5080, "84891L  A0", &bfin_a0 },
    { 0x3590, 0x5084, "54991L  A0", &bfin_a0 },
    { 0x3590, 0x5088, "54991EL A0", &bfin_a0 },
    { 0x3590, 0x50a0, "84892   A0", &bfin_a0 },
    { 0x3590, 0x50a4, "54992   A0", &bfin_a0 },
    { 0x3590, 0x50a8, "54992E  A0", &bfin_a0 },
    { 0x3590, 0x50b0, "84894   A0", &bfin_a0 },
    { 0x3590, 0x50b4, "54994   A0", &bfin_a0 },
    { 0x3590, 0x50b8, "54994E  A0", &bfin_a0 },
...
extern void dsl_runner_ext3_phy_init(phy_dev_t *phy_dev);
static int _phy_init(phy_dev_t *phy_dev)
{
    ...
    if ((ret = _phy_idle_stuffing_mode_set(phy_dev, phy_dev->mii_type == PHY_MII_TYPE_XFI)))
        goto Exit;
    ...
    dsl_runner_ext3_phy_init(phy_dev);
#endif
...
static int _phy_cfg(uint32_t enabled_phys)
{
    ...
    {
        printk("%s %x:%x --> ", phy_desc[i].name, phy_desc[i].phyid1, phy_desc[i].phyid2);

        phy_map = (_bus_read_all(enabled_phys, 0x01, 0x0002,  phy_desc[i].phyid1, 0xffff)) &
            (_bus_read_all(enabled_phys, 0x01, 0x0003,  phy_desc[i].phyid2, 0xffff));

        phy_desc[i].map = phy_map;
    ...
    for (i = 0; i < sizeof(phy_desc)/sizeof(phy_desc[0]); i++)
    {
        ...
        phy_desc[i].firmware->load(&phy_desc[i]);
    }
