...
#define IOCTL_AG_ROUTER_SOLICITATION_HOP_LIMIT_GET _IOR(MAJOR_NUM, 174, IOCTL_PARAM)
...
{                 
	...
	*hoplimit = 255;
    ...
    if(fd)
    {
        ...
        ioctl(fd, IOCTL_AG_ROUTER_SOLICITATION_HOP_LIMIT_GET, hoplimit);
