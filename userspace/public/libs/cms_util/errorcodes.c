...
const char *cmsErr_getStringBuf(CmsRet ret, char *buf, UINT32 buflen)
{
   ...
   case CMSRET_OPERATION_NOT_PERMITTED:
      errorStr = "Operation not permitted";
      break;

   case CMSRET_MANIFEST_PARSE_ERROR:
      errorStr = "Error parsing manifest";
      break;

   case CMSRET_OPERATION_IN_PROCESS:
      errorStr = "Operation in progress";
      break;
